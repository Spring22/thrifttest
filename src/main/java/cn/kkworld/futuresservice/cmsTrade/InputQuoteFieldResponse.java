...
public class InputQuoteFieldResponse implements org.apache.thrift.TBase<InputQuoteFieldResponse, InputQuoteFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InputQuoteFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InputQuoteFieldResponse");

  private static final org.apache.thrift.protocol.TField CTHOST_FTDC_INPUT_QUOTE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("CThostFtdcInputQuoteField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new InputQuoteFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InputQuoteFieldResponseTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    CTHOST_FTDC_INPUT_QUOTE_FIELD((short)1, "CThostFtdcInputQuoteField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // CTHOST_FTDC_INPUT_QUOTE_FIELD
          return CTHOST_FTDC_INPUT_QUOTE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.CTHOST_FTDC_INPUT_QUOTE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("CThostFtdcInputQuoteField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InputQuoteFieldResponse.class, metaDataMap);
  }

  public InputQuoteFieldResponse() {
  }
   ...
   */
  public InputQuoteFieldResponse(InputQuoteFieldResponse other) {
  ...
  public InputQuoteFieldResponse deepCopy() {
    return new InputQuoteFieldResponse(this);
  }
  ...
  public InputQuoteFieldResponse setCThostFtdcInputQuoteField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteField CThostFtdcInputQuoteField) {
    this.CThostFtdcInputQuoteField = CThostFtdcInputQuoteField;
    return this;
  }
  ...
  public InputQuoteFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InputQuoteFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InputQuoteFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case CTHOST_FTDC_INPUT_QUOTE_FIELD:
      if (value == null) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InputQuoteFieldResponse)
      return this.equals((InputQuoteFieldResponse)that);
    return false;
  }

  public boolean equals(InputQuoteFieldResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(InputQuoteFieldResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InputQuoteFieldResponse(");
    boolean first = true;
  ...
  private static class InputQuoteFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InputQuoteFieldResponseStandardScheme getScheme() {
      return new InputQuoteFieldResponseStandardScheme();
    }
  }

  private static class InputQuoteFieldResponseStandardScheme extends StandardScheme<InputQuoteFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InputQuoteFieldResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InputQuoteFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.CThostFtdcInputQuoteField != null) {
        oprot.writeFieldBegin(CTHOST_FTDC_INPUT_QUOTE_FIELD_FIELD_DESC);
  ...
  private static class InputQuoteFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InputQuoteFieldResponseTupleScheme getScheme() {
      return new InputQuoteFieldResponseTupleScheme();
    }
  }

  private static class InputQuoteFieldResponseTupleScheme extends TupleScheme<InputQuoteFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InputQuoteFieldResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InputQuoteFieldResponse struct) throws org.apache.thrift.TException {
