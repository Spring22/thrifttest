...
public class InputQuoteActionFieldResponse implements org.apache.thrift.TBase<InputQuoteActionFieldResponse, InputQuoteActionFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InputQuoteActionFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InputQuoteActionFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcInputQuoteActionField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new InputQuoteActionFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InputQuoteActionFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField cThostFtdcInputQuoteActionField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD((short)1, "cThostFtdcInputQuoteActionField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD
          return C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcInputQuoteActionField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InputQuoteActionFieldResponse.class, metaDataMap);
  }

  public InputQuoteActionFieldResponse() {
  }

  public InputQuoteActionFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField cThostFtdcInputQuoteActionField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcInputQuoteActionField = cThostFtdcInputQuoteActionField;
   ...
   */
  public InputQuoteActionFieldResponse(InputQuoteActionFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcInputQuoteActionField()) {
      this.cThostFtdcInputQuoteActionField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField(other.cThostFtdcInputQuoteActionField);
    }
  ...
  public InputQuoteActionFieldResponse deepCopy() {
    return new InputQuoteActionFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcInputQuoteActionField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField getCThostFtdcInputQuoteActionField() {
    return this.cThostFtdcInputQuoteActionField;
  }

  public InputQuoteActionFieldResponse setCThostFtdcInputQuoteActionField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField cThostFtdcInputQuoteActionField) {
    this.cThostFtdcInputQuoteActionField = cThostFtdcInputQuoteActionField;
    return this;
  }

  public void unsetCThostFtdcInputQuoteActionField() {
    this.cThostFtdcInputQuoteActionField = null;
  }

  /** Returns true if field cThostFtdcInputQuoteActionField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcInputQuoteActionField() {
    return this.cThostFtdcInputQuoteActionField != null;
  }

  public void setCThostFtdcInputQuoteActionFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcInputQuoteActionField = null;
    }
  }
  ...
  public InputQuoteActionFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InputQuoteActionFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InputQuoteActionFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD:
      if (value == null) {
        unsetCThostFtdcInputQuoteActionField();
      } else {
        setCThostFtdcInputQuoteActionField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD:
      return getCThostFtdcInputQuoteActionField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD:
      return isSetCThostFtdcInputQuoteActionField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InputQuoteActionFieldResponse)
      return this.equals((InputQuoteActionFieldResponse)that);
    return false;
  }

  public boolean equals(InputQuoteActionFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcInputQuoteActionField = true && this.isSetCThostFtdcInputQuoteActionField();
    boolean that_present_cThostFtdcInputQuoteActionField = true && that.isSetCThostFtdcInputQuoteActionField();
    if (this_present_cThostFtdcInputQuoteActionField || that_present_cThostFtdcInputQuoteActionField) {
      if (!(this_present_cThostFtdcInputQuoteActionField && that_present_cThostFtdcInputQuoteActionField))
        return false;
      if (!this.cThostFtdcInputQuoteActionField.equals(that.cThostFtdcInputQuoteActionField))
        return false;
    }
  ...
  @Override
  public int compareTo(InputQuoteActionFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcInputQuoteActionField()).compareTo(other.isSetCThostFtdcInputQuoteActionField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcInputQuoteActionField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcInputQuoteActionField, other.cThostFtdcInputQuoteActionField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InputQuoteActionFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcInputQuoteActionField:");
    if (this.cThostFtdcInputQuoteActionField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcInputQuoteActionField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcInputQuoteActionField != null) {
      cThostFtdcInputQuoteActionField.validate();
    }
  ...
  private static class InputQuoteActionFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InputQuoteActionFieldResponseStandardScheme getScheme() {
      return new InputQuoteActionFieldResponseStandardScheme();
    }
  }

  private static class InputQuoteActionFieldResponseStandardScheme extends StandardScheme<InputQuoteActionFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InputQuoteActionFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcInputQuoteActionField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputQuoteActionField();
              struct.cThostFtdcInputQuoteActionField.read(iprot);
              struct.setCThostFtdcInputQuoteActionFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InputQuoteActionFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcInputQuoteActionField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_INPUT_QUOTE_ACTION_FIELD_FIELD_DESC);
        struct.cThostFtdcInputQuoteActionField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class InputQuoteActionFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InputQuoteActionFieldResponseTupleScheme getScheme() {
      return new InputQuoteActionFieldResponseTupleScheme();
    }
  }

  private static class InputQuoteActionFieldResponseTupleScheme extends TupleScheme<InputQuoteActionFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InputQuoteActionFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcInputQuoteActionField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InputQuoteActionFieldResponse struct) throws org.apache.thrift.TException {
