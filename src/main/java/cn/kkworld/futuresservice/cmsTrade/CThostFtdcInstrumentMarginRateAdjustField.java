...
public class CThostFtdcInstrumentMarginRateAdjustField implements org.apache.thrift.TBase<CThostFtdcInstrumentMarginRateAdjustField, CThostFtdcInstrumentMarginRateAdjustField._Fields>, java.io.Serializable, Cloneable, Comparable<CThostFtdcInstrumentMarginRateAdjustField> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CThostFtdcInstrumentMarginRateAdjustField");
  ...
  static {
    schemes.put(StandardScheme.class, new CThostFtdcInstrumentMarginRateAdjustFieldStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CThostFtdcInstrumentMarginRateAdjustFieldTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CThostFtdcInstrumentMarginRateAdjustField.class, metaDataMap);
  }
   ...
   */
  public CThostFtdcInstrumentMarginRateAdjustField(CThostFtdcInstrumentMarginRateAdjustField other) {
  ...
  public CThostFtdcInstrumentMarginRateAdjustField deepCopy() {
    return new CThostFtdcInstrumentMarginRateAdjustField(this);
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setInstrumentID(String instrumentID) {
    this.instrumentID = instrumentID;
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setInvestorRange(String investorRange) {
    this.investorRange = investorRange;
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setBrokerID(String brokerID) {
    this.brokerID = brokerID;
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setInvestorID(String investorID) {
    this.investorID = investorID;
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setHedgeFlag(String hedgeFlag) {
    this.hedgeFlag = hedgeFlag;
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setLongMarginRatioByMoney(double longMarginRatioByMoney) {
    this.longMarginRatioByMoney = longMarginRatioByMoney;
    setLongMarginRatioByMoneyIsSet(true);
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setLongMarginRatioByVolume(double longMarginRatioByVolume) {
    this.longMarginRatioByVolume = longMarginRatioByVolume;
    setLongMarginRatioByVolumeIsSet(true);
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setShortMarginRatioByMoney(double shortMarginRatioByMoney) {
    this.shortMarginRatioByMoney = shortMarginRatioByMoney;
    setShortMarginRatioByMoneyIsSet(true);
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setShortMarginRatioByVolume(double shortMarginRatioByVolume) {
    this.shortMarginRatioByVolume = shortMarginRatioByVolume;
    setShortMarginRatioByVolumeIsSet(true);
    return this;
  }
  ...
  public CThostFtdcInstrumentMarginRateAdjustField setIsRelative(int isRelative) {
    this.isRelative = isRelative;
    setIsRelativeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CThostFtdcInstrumentMarginRateAdjustField)
      return this.equals((CThostFtdcInstrumentMarginRateAdjustField)that);
    return false;
  }

  public boolean equals(CThostFtdcInstrumentMarginRateAdjustField that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CThostFtdcInstrumentMarginRateAdjustField other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CThostFtdcInstrumentMarginRateAdjustField(");
    boolean first = true;
  ...
  private static class CThostFtdcInstrumentMarginRateAdjustFieldStandardSchemeFactory implements SchemeFactory {
    public CThostFtdcInstrumentMarginRateAdjustFieldStandardScheme getScheme() {
      return new CThostFtdcInstrumentMarginRateAdjustFieldStandardScheme();
    }
  }

  private static class CThostFtdcInstrumentMarginRateAdjustFieldStandardScheme extends StandardScheme<CThostFtdcInstrumentMarginRateAdjustField> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CThostFtdcInstrumentMarginRateAdjustField struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CThostFtdcInstrumentMarginRateAdjustField struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CThostFtdcInstrumentMarginRateAdjustFieldTupleSchemeFactory implements SchemeFactory {
    public CThostFtdcInstrumentMarginRateAdjustFieldTupleScheme getScheme() {
      return new CThostFtdcInstrumentMarginRateAdjustFieldTupleScheme();
    }
  }

  private static class CThostFtdcInstrumentMarginRateAdjustFieldTupleScheme extends TupleScheme<CThostFtdcInstrumentMarginRateAdjustField> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CThostFtdcInstrumentMarginRateAdjustField struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CThostFtdcInstrumentMarginRateAdjustField struct) throws org.apache.thrift.TException {
