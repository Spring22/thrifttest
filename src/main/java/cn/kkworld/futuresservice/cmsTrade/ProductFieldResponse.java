...
public class ProductFieldResponse implements org.apache.thrift.TBase<ProductFieldResponse, ProductFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ProductFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProductFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_PRODUCT_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcProductField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ProductFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProductFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField cThostFtdcProductField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_PRODUCT_FIELD((short)1, "cThostFtdcProductField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_PRODUCT_FIELD
          return C_THOST_FTDC_PRODUCT_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_PRODUCT_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcProductField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProductFieldResponse.class, metaDataMap);
  }

  public ProductFieldResponse() {
  }

  public ProductFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField cThostFtdcProductField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcProductField = cThostFtdcProductField;
   ...
   */
  public ProductFieldResponse(ProductFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcProductField()) {
      this.cThostFtdcProductField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField(other.cThostFtdcProductField);
    }
  ...
  public ProductFieldResponse deepCopy() {
    return new ProductFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcProductField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField getCThostFtdcProductField() {
    return this.cThostFtdcProductField;
  }

  public ProductFieldResponse setCThostFtdcProductField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField cThostFtdcProductField) {
    this.cThostFtdcProductField = cThostFtdcProductField;
    return this;
  }

  public void unsetCThostFtdcProductField() {
    this.cThostFtdcProductField = null;
  }

  /** Returns true if field cThostFtdcProductField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcProductField() {
    return this.cThostFtdcProductField != null;
  }

  public void setCThostFtdcProductFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcProductField = null;
    }
  }
  ...
  public ProductFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ProductFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ProductFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_PRODUCT_FIELD:
      if (value == null) {
        unsetCThostFtdcProductField();
      } else {
        setCThostFtdcProductField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_PRODUCT_FIELD:
      return getCThostFtdcProductField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_PRODUCT_FIELD:
      return isSetCThostFtdcProductField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProductFieldResponse)
      return this.equals((ProductFieldResponse)that);
    return false;
  }

  public boolean equals(ProductFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcProductField = true && this.isSetCThostFtdcProductField();
    boolean that_present_cThostFtdcProductField = true && that.isSetCThostFtdcProductField();
    if (this_present_cThostFtdcProductField || that_present_cThostFtdcProductField) {
      if (!(this_present_cThostFtdcProductField && that_present_cThostFtdcProductField))
        return false;
      if (!this.cThostFtdcProductField.equals(that.cThostFtdcProductField))
        return false;
    }
  ...
  @Override
  public int compareTo(ProductFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcProductField()).compareTo(other.isSetCThostFtdcProductField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcProductField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcProductField, other.cThostFtdcProductField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProductFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcProductField:");
    if (this.cThostFtdcProductField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcProductField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcProductField != null) {
      cThostFtdcProductField.validate();
    }
  ...
  private static class ProductFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ProductFieldResponseStandardScheme getScheme() {
      return new ProductFieldResponseStandardScheme();
    }
  }

  private static class ProductFieldResponseStandardScheme extends StandardScheme<ProductFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProductFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_PRODUCT_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcProductField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcProductField();
              struct.cThostFtdcProductField.read(iprot);
              struct.setCThostFtdcProductFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcProductField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_PRODUCT_FIELD_FIELD_DESC);
        struct.cThostFtdcProductField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ProductFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ProductFieldResponseTupleScheme getScheme() {
      return new ProductFieldResponseTupleScheme();
    }
  }

  private static class ProductFieldResponseTupleScheme extends TupleScheme<ProductFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProductFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcProductField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProductFieldResponse struct) throws org.apache.thrift.TException {
