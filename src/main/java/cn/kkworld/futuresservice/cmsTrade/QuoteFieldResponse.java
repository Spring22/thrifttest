...
public class QuoteFieldResponse implements org.apache.thrift.TBase<QuoteFieldResponse, QuoteFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<QuoteFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QuoteFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_QUOTE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcQuoteField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new QuoteFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QuoteFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField cThostFtdcQuoteField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_QUOTE_FIELD((short)1, "cThostFtdcQuoteField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_QUOTE_FIELD
          return C_THOST_FTDC_QUOTE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_QUOTE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcQuoteField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QuoteFieldResponse.class, metaDataMap);
  }

  public QuoteFieldResponse() {
  }

  public QuoteFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField cThostFtdcQuoteField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcQuoteField = cThostFtdcQuoteField;
   ...
   */
  public QuoteFieldResponse(QuoteFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcQuoteField()) {
      this.cThostFtdcQuoteField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField(other.cThostFtdcQuoteField);
    }
  ...
  public QuoteFieldResponse deepCopy() {
    return new QuoteFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcQuoteField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField getCThostFtdcQuoteField() {
    return this.cThostFtdcQuoteField;
  }

  public QuoteFieldResponse setCThostFtdcQuoteField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField cThostFtdcQuoteField) {
    this.cThostFtdcQuoteField = cThostFtdcQuoteField;
    return this;
  }

  public void unsetCThostFtdcQuoteField() {
    this.cThostFtdcQuoteField = null;
  }

  /** Returns true if field cThostFtdcQuoteField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcQuoteField() {
    return this.cThostFtdcQuoteField != null;
  }

  public void setCThostFtdcQuoteFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcQuoteField = null;
    }
  }
  ...
  public QuoteFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public QuoteFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public QuoteFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_QUOTE_FIELD:
      if (value == null) {
        unsetCThostFtdcQuoteField();
      } else {
        setCThostFtdcQuoteField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_QUOTE_FIELD:
      return getCThostFtdcQuoteField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_QUOTE_FIELD:
      return isSetCThostFtdcQuoteField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QuoteFieldResponse)
      return this.equals((QuoteFieldResponse)that);
    return false;
  }

  public boolean equals(QuoteFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcQuoteField = true && this.isSetCThostFtdcQuoteField();
    boolean that_present_cThostFtdcQuoteField = true && that.isSetCThostFtdcQuoteField();
    if (this_present_cThostFtdcQuoteField || that_present_cThostFtdcQuoteField) {
      if (!(this_present_cThostFtdcQuoteField && that_present_cThostFtdcQuoteField))
        return false;
      if (!this.cThostFtdcQuoteField.equals(that.cThostFtdcQuoteField))
        return false;
    }
  ...
  @Override
  public int compareTo(QuoteFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcQuoteField()).compareTo(other.isSetCThostFtdcQuoteField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcQuoteField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcQuoteField, other.cThostFtdcQuoteField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QuoteFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcQuoteField:");
    if (this.cThostFtdcQuoteField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcQuoteField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class QuoteFieldResponseStandardSchemeFactory implements SchemeFactory {
    public QuoteFieldResponseStandardScheme getScheme() {
      return new QuoteFieldResponseStandardScheme();
    }
  }

  private static class QuoteFieldResponseStandardScheme extends StandardScheme<QuoteFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QuoteFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_QUOTE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcQuoteField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcQuoteField();
              struct.cThostFtdcQuoteField.read(iprot);
              struct.setCThostFtdcQuoteFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QuoteFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcQuoteField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_QUOTE_FIELD_FIELD_DESC);
        struct.cThostFtdcQuoteField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class QuoteFieldResponseTupleSchemeFactory implements SchemeFactory {
    public QuoteFieldResponseTupleScheme getScheme() {
      return new QuoteFieldResponseTupleScheme();
    }
  }

  private static class QuoteFieldResponseTupleScheme extends TupleScheme<QuoteFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QuoteFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcQuoteField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QuoteFieldResponse struct) throws org.apache.thrift.TException {
