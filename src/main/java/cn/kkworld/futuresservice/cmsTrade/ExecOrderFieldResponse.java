...
public class ExecOrderFieldResponse implements org.apache.thrift.TBase<ExecOrderFieldResponse, ExecOrderFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ExecOrderFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExecOrderFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_EXEC_ORDER_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcExecOrderField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ExecOrderFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ExecOrderFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField cThostFtdcExecOrderField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_EXEC_ORDER_FIELD((short)1, "cThostFtdcExecOrderField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_EXEC_ORDER_FIELD
          return C_THOST_FTDC_EXEC_ORDER_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_EXEC_ORDER_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcExecOrderField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExecOrderFieldResponse.class, metaDataMap);
  }

  public ExecOrderFieldResponse() {
  }

  public ExecOrderFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField cThostFtdcExecOrderField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcExecOrderField = cThostFtdcExecOrderField;
   ...
   */
  public ExecOrderFieldResponse(ExecOrderFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcExecOrderField()) {
      this.cThostFtdcExecOrderField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField(other.cThostFtdcExecOrderField);
    }
  ...
  public ExecOrderFieldResponse deepCopy() {
    return new ExecOrderFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcExecOrderField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField getCThostFtdcExecOrderField() {
    return this.cThostFtdcExecOrderField;
  }

  public ExecOrderFieldResponse setCThostFtdcExecOrderField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField cThostFtdcExecOrderField) {
    this.cThostFtdcExecOrderField = cThostFtdcExecOrderField;
    return this;
  }

  public void unsetCThostFtdcExecOrderField() {
    this.cThostFtdcExecOrderField = null;
  }

  /** Returns true if field cThostFtdcExecOrderField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcExecOrderField() {
    return this.cThostFtdcExecOrderField != null;
  }

  public void setCThostFtdcExecOrderFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcExecOrderField = null;
    }
  }
  ...
  public ExecOrderFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ExecOrderFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ExecOrderFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_EXEC_ORDER_FIELD:
      if (value == null) {
        unsetCThostFtdcExecOrderField();
      } else {
        setCThostFtdcExecOrderField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_EXEC_ORDER_FIELD:
      return getCThostFtdcExecOrderField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_EXEC_ORDER_FIELD:
      return isSetCThostFtdcExecOrderField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExecOrderFieldResponse)
      return this.equals((ExecOrderFieldResponse)that);
    return false;
  }

  public boolean equals(ExecOrderFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcExecOrderField = true && this.isSetCThostFtdcExecOrderField();
    boolean that_present_cThostFtdcExecOrderField = true && that.isSetCThostFtdcExecOrderField();
    if (this_present_cThostFtdcExecOrderField || that_present_cThostFtdcExecOrderField) {
      if (!(this_present_cThostFtdcExecOrderField && that_present_cThostFtdcExecOrderField))
        return false;
      if (!this.cThostFtdcExecOrderField.equals(that.cThostFtdcExecOrderField))
        return false;
    }
  ...
  @Override
  public int compareTo(ExecOrderFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcExecOrderField()).compareTo(other.isSetCThostFtdcExecOrderField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcExecOrderField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcExecOrderField, other.cThostFtdcExecOrderField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ExecOrderFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcExecOrderField:");
    if (this.cThostFtdcExecOrderField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcExecOrderField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcExecOrderField != null) {
      cThostFtdcExecOrderField.validate();
    }
  ...
  private static class ExecOrderFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ExecOrderFieldResponseStandardScheme getScheme() {
      return new ExecOrderFieldResponseStandardScheme();
    }
  }

  private static class ExecOrderFieldResponseStandardScheme extends StandardScheme<ExecOrderFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ExecOrderFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_EXEC_ORDER_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcExecOrderField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcExecOrderField();
              struct.cThostFtdcExecOrderField.read(iprot);
              struct.setCThostFtdcExecOrderFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExecOrderFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcExecOrderField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_EXEC_ORDER_FIELD_FIELD_DESC);
        struct.cThostFtdcExecOrderField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ExecOrderFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ExecOrderFieldResponseTupleScheme getScheme() {
      return new ExecOrderFieldResponseTupleScheme();
    }
  }

  private static class ExecOrderFieldResponseTupleScheme extends TupleScheme<ExecOrderFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ExecOrderFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcExecOrderField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ExecOrderFieldResponse struct) throws org.apache.thrift.TException {
