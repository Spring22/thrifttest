...
public class InputOrderFieldResponse implements org.apache.thrift.TBase<InputOrderFieldResponse, InputOrderFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InputOrderFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InputOrderFieldResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new InputOrderFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InputOrderFieldResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InputOrderFieldResponse.class, metaDataMap);
  }

  public InputOrderFieldResponse() {
  }
   ...
   */
  public InputOrderFieldResponse(InputOrderFieldResponse other) {
  ...
  public InputOrderFieldResponse deepCopy() {
    return new InputOrderFieldResponse(this);
  }
  ...
  public InputOrderFieldResponse setCThostFtdcInputOrderField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderField cThostFtdcInputOrderField) {
    this.cThostFtdcInputOrderField = cThostFtdcInputOrderField;
    return this;
  }
  ...
  public InputOrderFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InputOrderFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InputOrderFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InputOrderFieldResponse)
      return this.equals((InputOrderFieldResponse)that);
    return false;
  }

  public boolean equals(InputOrderFieldResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(InputOrderFieldResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InputOrderFieldResponse(");
    boolean first = true;
  ...
  private static class InputOrderFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InputOrderFieldResponseStandardScheme getScheme() {
      return new InputOrderFieldResponseStandardScheme();
    }
  }

  private static class InputOrderFieldResponseStandardScheme extends StandardScheme<InputOrderFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InputOrderFieldResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InputOrderFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class InputOrderFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InputOrderFieldResponseTupleScheme getScheme() {
      return new InputOrderFieldResponseTupleScheme();
    }
  }

  private static class InputOrderFieldResponseTupleScheme extends TupleScheme<InputOrderFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InputOrderFieldResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InputOrderFieldResponse struct) throws org.apache.thrift.TException {
