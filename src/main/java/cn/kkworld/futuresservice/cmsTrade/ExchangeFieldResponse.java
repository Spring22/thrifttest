...
public class ExchangeFieldResponse implements org.apache.thrift.TBase<ExchangeFieldResponse, ExchangeFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ExchangeFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExchangeFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_EXCHANGE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcExchangeField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ExchangeFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ExchangeFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField cThostFtdcExchangeField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_EXCHANGE_FIELD((short)1, "cThostFtdcExchangeField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_EXCHANGE_FIELD
          return C_THOST_FTDC_EXCHANGE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_EXCHANGE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcExchangeField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExchangeFieldResponse.class, metaDataMap);
  }

  public ExchangeFieldResponse() {
  }

  public ExchangeFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField cThostFtdcExchangeField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcExchangeField = cThostFtdcExchangeField;
   ...
   */
  public ExchangeFieldResponse(ExchangeFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcExchangeField()) {
      this.cThostFtdcExchangeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField(other.cThostFtdcExchangeField);
    }
  ...
  public ExchangeFieldResponse deepCopy() {
    return new ExchangeFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcExchangeField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField getCThostFtdcExchangeField() {
    return this.cThostFtdcExchangeField;
  }

  public ExchangeFieldResponse setCThostFtdcExchangeField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField cThostFtdcExchangeField) {
    this.cThostFtdcExchangeField = cThostFtdcExchangeField;
    return this;
  }

  public void unsetCThostFtdcExchangeField() {
    this.cThostFtdcExchangeField = null;
  }

  /** Returns true if field cThostFtdcExchangeField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcExchangeField() {
    return this.cThostFtdcExchangeField != null;
  }

  public void setCThostFtdcExchangeFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcExchangeField = null;
    }
  }
  ...
  public ExchangeFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ExchangeFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ExchangeFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_EXCHANGE_FIELD:
      if (value == null) {
        unsetCThostFtdcExchangeField();
      } else {
        setCThostFtdcExchangeField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_EXCHANGE_FIELD:
      return getCThostFtdcExchangeField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_EXCHANGE_FIELD:
      return isSetCThostFtdcExchangeField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExchangeFieldResponse)
      return this.equals((ExchangeFieldResponse)that);
    return false;
  }

  public boolean equals(ExchangeFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcExchangeField = true && this.isSetCThostFtdcExchangeField();
    boolean that_present_cThostFtdcExchangeField = true && that.isSetCThostFtdcExchangeField();
    if (this_present_cThostFtdcExchangeField || that_present_cThostFtdcExchangeField) {
      if (!(this_present_cThostFtdcExchangeField && that_present_cThostFtdcExchangeField))
        return false;
      if (!this.cThostFtdcExchangeField.equals(that.cThostFtdcExchangeField))
        return false;
    }
  ...
  @Override
  public int compareTo(ExchangeFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcExchangeField()).compareTo(other.isSetCThostFtdcExchangeField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcExchangeField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcExchangeField, other.cThostFtdcExchangeField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ExchangeFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcExchangeField:");
    if (this.cThostFtdcExchangeField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcExchangeField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcExchangeField != null) {
      cThostFtdcExchangeField.validate();
    }
  ...
  private static class ExchangeFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ExchangeFieldResponseStandardScheme getScheme() {
      return new ExchangeFieldResponseStandardScheme();
    }
  }

  private static class ExchangeFieldResponseStandardScheme extends StandardScheme<ExchangeFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ExchangeFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_EXCHANGE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcExchangeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeField();
              struct.cThostFtdcExchangeField.read(iprot);
              struct.setCThostFtdcExchangeFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExchangeFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcExchangeField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_EXCHANGE_FIELD_FIELD_DESC);
        struct.cThostFtdcExchangeField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ExchangeFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ExchangeFieldResponseTupleScheme getScheme() {
      return new ExchangeFieldResponseTupleScheme();
    }
  }

  private static class ExchangeFieldResponseTupleScheme extends TupleScheme<ExchangeFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ExchangeFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcExchangeField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ExchangeFieldResponse struct) throws org.apache.thrift.TException {
