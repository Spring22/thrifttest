...
public class InstrumentFieldResponse implements org.apache.thrift.TBase<InstrumentFieldResponse, InstrumentFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InstrumentFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InstrumentFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_INSTRUMENT_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcInstrumentField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new InstrumentFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InstrumentFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField cThostFtdcInstrumentField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_INSTRUMENT_FIELD((short)1, "cThostFtdcInstrumentField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_INSTRUMENT_FIELD
          return C_THOST_FTDC_INSTRUMENT_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_INSTRUMENT_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcInstrumentField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InstrumentFieldResponse.class, metaDataMap);
  }

  public InstrumentFieldResponse() {
  }

  public InstrumentFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField cThostFtdcInstrumentField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcInstrumentField = cThostFtdcInstrumentField;
   ...
   */
  public InstrumentFieldResponse(InstrumentFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcInstrumentField()) {
      this.cThostFtdcInstrumentField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField(other.cThostFtdcInstrumentField);
    }
  ...
  public InstrumentFieldResponse deepCopy() {
    return new InstrumentFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcInstrumentField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField getCThostFtdcInstrumentField() {
    return this.cThostFtdcInstrumentField;
  }

  public InstrumentFieldResponse setCThostFtdcInstrumentField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField cThostFtdcInstrumentField) {
    this.cThostFtdcInstrumentField = cThostFtdcInstrumentField;
    return this;
  }

  public void unsetCThostFtdcInstrumentField() {
    this.cThostFtdcInstrumentField = null;
  }

  /** Returns true if field cThostFtdcInstrumentField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcInstrumentField() {
    return this.cThostFtdcInstrumentField != null;
  }

  public void setCThostFtdcInstrumentFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcInstrumentField = null;
    }
  }
  ...
  public InstrumentFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InstrumentFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InstrumentFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_INSTRUMENT_FIELD:
      if (value == null) {
        unsetCThostFtdcInstrumentField();
      } else {
        setCThostFtdcInstrumentField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_INSTRUMENT_FIELD:
      return getCThostFtdcInstrumentField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_INSTRUMENT_FIELD:
      return isSetCThostFtdcInstrumentField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InstrumentFieldResponse)
      return this.equals((InstrumentFieldResponse)that);
    return false;
  }

  public boolean equals(InstrumentFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcInstrumentField = true && this.isSetCThostFtdcInstrumentField();
    boolean that_present_cThostFtdcInstrumentField = true && that.isSetCThostFtdcInstrumentField();
    if (this_present_cThostFtdcInstrumentField || that_present_cThostFtdcInstrumentField) {
      if (!(this_present_cThostFtdcInstrumentField && that_present_cThostFtdcInstrumentField))
        return false;
      if (!this.cThostFtdcInstrumentField.equals(that.cThostFtdcInstrumentField))
        return false;
    }
  ...
  @Override
  public int compareTo(InstrumentFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcInstrumentField()).compareTo(other.isSetCThostFtdcInstrumentField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcInstrumentField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcInstrumentField, other.cThostFtdcInstrumentField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InstrumentFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcInstrumentField:");
    if (this.cThostFtdcInstrumentField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcInstrumentField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcInstrumentField != null) {
      cThostFtdcInstrumentField.validate();
    }
  ...
  private static class InstrumentFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InstrumentFieldResponseStandardScheme getScheme() {
      return new InstrumentFieldResponseStandardScheme();
    }
  }

  private static class InstrumentFieldResponseStandardScheme extends StandardScheme<InstrumentFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InstrumentFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_INSTRUMENT_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcInstrumentField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInstrumentField();
              struct.cThostFtdcInstrumentField.read(iprot);
              struct.setCThostFtdcInstrumentFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InstrumentFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcInstrumentField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_INSTRUMENT_FIELD_FIELD_DESC);
        struct.cThostFtdcInstrumentField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class InstrumentFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InstrumentFieldResponseTupleScheme getScheme() {
      return new InstrumentFieldResponseTupleScheme();
    }
  }

  private static class InstrumentFieldResponseTupleScheme extends TupleScheme<InstrumentFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InstrumentFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcInstrumentField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InstrumentFieldResponse struct) throws org.apache.thrift.TException {
