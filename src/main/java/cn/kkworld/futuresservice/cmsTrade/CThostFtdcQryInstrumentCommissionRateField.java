...
public class CThostFtdcQryInstrumentCommissionRateField implements org.apache.thrift.TBase<CThostFtdcQryInstrumentCommissionRateField, CThostFtdcQryInstrumentCommissionRateField._Fields>, java.io.Serializable, Cloneable, Comparable<CThostFtdcQryInstrumentCommissionRateField> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CThostFtdcQryInstrumentCommissionRateField");
  ...
  static {
    schemes.put(StandardScheme.class, new CThostFtdcQryInstrumentCommissionRateFieldStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CThostFtdcQryInstrumentCommissionRateFieldTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CThostFtdcQryInstrumentCommissionRateField.class, metaDataMap);
  }
   ...
   */
  public CThostFtdcQryInstrumentCommissionRateField(CThostFtdcQryInstrumentCommissionRateField other) {
  ...
  public CThostFtdcQryInstrumentCommissionRateField deepCopy() {
    return new CThostFtdcQryInstrumentCommissionRateField(this);
  }
  ...
  public CThostFtdcQryInstrumentCommissionRateField setBrokerID(String brokerID) {
    this.brokerID = brokerID;
    return this;
  }
  ...
  public CThostFtdcQryInstrumentCommissionRateField setInvestorID(String investorID) {
    this.investorID = investorID;
    return this;
  }
  ...
  public CThostFtdcQryInstrumentCommissionRateField setInstrumentID(String instrumentID) {
    this.instrumentID = instrumentID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CThostFtdcQryInstrumentCommissionRateField)
      return this.equals((CThostFtdcQryInstrumentCommissionRateField)that);
    return false;
  }

  public boolean equals(CThostFtdcQryInstrumentCommissionRateField that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CThostFtdcQryInstrumentCommissionRateField other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CThostFtdcQryInstrumentCommissionRateField(");
    boolean first = true;
  ...
  private static class CThostFtdcQryInstrumentCommissionRateFieldStandardSchemeFactory implements SchemeFactory {
    public CThostFtdcQryInstrumentCommissionRateFieldStandardScheme getScheme() {
      return new CThostFtdcQryInstrumentCommissionRateFieldStandardScheme();
    }
  }

  private static class CThostFtdcQryInstrumentCommissionRateFieldStandardScheme extends StandardScheme<CThostFtdcQryInstrumentCommissionRateField> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CThostFtdcQryInstrumentCommissionRateField struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CThostFtdcQryInstrumentCommissionRateField struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CThostFtdcQryInstrumentCommissionRateFieldTupleSchemeFactory implements SchemeFactory {
    public CThostFtdcQryInstrumentCommissionRateFieldTupleScheme getScheme() {
      return new CThostFtdcQryInstrumentCommissionRateFieldTupleScheme();
    }
  }

  private static class CThostFtdcQryInstrumentCommissionRateFieldTupleScheme extends TupleScheme<CThostFtdcQryInstrumentCommissionRateField> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CThostFtdcQryInstrumentCommissionRateField struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CThostFtdcQryInstrumentCommissionRateField struct) throws org.apache.thrift.TException {
