...
public class InputOrderActionFieldResponse implements org.apache.thrift.TBase<InputOrderActionFieldResponse, InputOrderActionFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InputOrderActionFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InputOrderActionFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcInputOrderActionField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new InputOrderActionFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InputOrderActionFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField cThostFtdcInputOrderActionField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD((short)1, "cThostFtdcInputOrderActionField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD
          return C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcInputOrderActionField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InputOrderActionFieldResponse.class, metaDataMap);
  }

  public InputOrderActionFieldResponse() {
  }

  public InputOrderActionFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField cThostFtdcInputOrderActionField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcInputOrderActionField = cThostFtdcInputOrderActionField;
   ...
   */
  public InputOrderActionFieldResponse(InputOrderActionFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcInputOrderActionField()) {
      this.cThostFtdcInputOrderActionField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField(other.cThostFtdcInputOrderActionField);
    }
  ...
  public InputOrderActionFieldResponse deepCopy() {
    return new InputOrderActionFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcInputOrderActionField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField getCThostFtdcInputOrderActionField() {
    return this.cThostFtdcInputOrderActionField;
  }

  public InputOrderActionFieldResponse setCThostFtdcInputOrderActionField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField cThostFtdcInputOrderActionField) {
    this.cThostFtdcInputOrderActionField = cThostFtdcInputOrderActionField;
    return this;
  }

  public void unsetCThostFtdcInputOrderActionField() {
    this.cThostFtdcInputOrderActionField = null;
  }

  /** Returns true if field cThostFtdcInputOrderActionField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcInputOrderActionField() {
    return this.cThostFtdcInputOrderActionField != null;
  }

  public void setCThostFtdcInputOrderActionFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcInputOrderActionField = null;
    }
  }
  ...
  public InputOrderActionFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InputOrderActionFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InputOrderActionFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD:
      if (value == null) {
        unsetCThostFtdcInputOrderActionField();
      } else {
        setCThostFtdcInputOrderActionField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD:
      return getCThostFtdcInputOrderActionField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD:
      return isSetCThostFtdcInputOrderActionField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InputOrderActionFieldResponse)
      return this.equals((InputOrderActionFieldResponse)that);
    return false;
  }

  public boolean equals(InputOrderActionFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcInputOrderActionField = true && this.isSetCThostFtdcInputOrderActionField();
    boolean that_present_cThostFtdcInputOrderActionField = true && that.isSetCThostFtdcInputOrderActionField();
    if (this_present_cThostFtdcInputOrderActionField || that_present_cThostFtdcInputOrderActionField) {
      if (!(this_present_cThostFtdcInputOrderActionField && that_present_cThostFtdcInputOrderActionField))
        return false;
      if (!this.cThostFtdcInputOrderActionField.equals(that.cThostFtdcInputOrderActionField))
        return false;
    }
  ...
  @Override
  public int compareTo(InputOrderActionFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcInputOrderActionField()).compareTo(other.isSetCThostFtdcInputOrderActionField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcInputOrderActionField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcInputOrderActionField, other.cThostFtdcInputOrderActionField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InputOrderActionFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcInputOrderActionField:");
    if (this.cThostFtdcInputOrderActionField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcInputOrderActionField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcInputOrderActionField != null) {
      cThostFtdcInputOrderActionField.validate();
    }
  ...
  private static class InputOrderActionFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InputOrderActionFieldResponseStandardScheme getScheme() {
      return new InputOrderActionFieldResponseStandardScheme();
    }
  }

  private static class InputOrderActionFieldResponseStandardScheme extends StandardScheme<InputOrderActionFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InputOrderActionFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcInputOrderActionField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputOrderActionField();
              struct.cThostFtdcInputOrderActionField.read(iprot);
              struct.setCThostFtdcInputOrderActionFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InputOrderActionFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcInputOrderActionField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_INPUT_ORDER_ACTION_FIELD_FIELD_DESC);
        struct.cThostFtdcInputOrderActionField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class InputOrderActionFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InputOrderActionFieldResponseTupleScheme getScheme() {
      return new InputOrderActionFieldResponseTupleScheme();
    }
  }

  private static class InputOrderActionFieldResponseTupleScheme extends TupleScheme<InputOrderActionFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InputOrderActionFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcInputOrderActionField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InputOrderActionFieldResponse struct) throws org.apache.thrift.TException {
