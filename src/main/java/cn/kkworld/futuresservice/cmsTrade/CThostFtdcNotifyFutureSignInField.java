...
public class CThostFtdcNotifyFutureSignInField implements org.apache.thrift.TBase<CThostFtdcNotifyFutureSignInField, CThostFtdcNotifyFutureSignInField._Fields>, java.io.Serializable, Cloneable, Comparable<CThostFtdcNotifyFutureSignInField> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CThostFtdcNotifyFutureSignInField");
  ...
  private static final org.apache.thrift.protocol.TField PIN_KEY_FIELD_DESC = new org.apache.thrift.protocol.TField("pinKey", org.apache.thrift.protocol.TType.STRING, (short)24);
  private static final org.apache.thrift.protocol.TField MAC_KEY_FIELD_DESC = new org.apache.thrift.protocol.TField("macKey", org.apache.thrift.protocol.TType.STRING, (short)25);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new CThostFtdcNotifyFutureSignInFieldStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CThostFtdcNotifyFutureSignInFieldTupleSchemeFactory());
  }
  ...
  public String pinKey; // required
  public String macKey; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PIN_KEY((short)24, "pinKey"),
    MAC_KEY((short)25, "macKey");
  ...
  static {
    ...
    tmpMap.put(_Fields.PIN_KEY, new org.apache.thrift.meta_data.FieldMetaData("pinKey", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "TThostFtdcPasswordKeyType")));
    tmpMap.put(_Fields.MAC_KEY, new org.apache.thrift.meta_data.FieldMetaData("macKey", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "TThostFtdcPasswordKeyType")));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CThostFtdcNotifyFutureSignInField.class, metaDataMap);
  }
   ...
   */
  public CThostFtdcNotifyFutureSignInField(CThostFtdcNotifyFutureSignInField other) {
    ...
    if (other.isSetPinKey()) {
      this.pinKey = other.pinKey;
    }
  ...
  public CThostFtdcNotifyFutureSignInField deepCopy() {
    return new CThostFtdcNotifyFutureSignInField(this);
  }
  ...
  public CThostFtdcNotifyFutureSignInField setTradeCode(String tradeCode) {
    this.tradeCode = tradeCode;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setBankID(String bankID) {
    this.bankID = bankID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setBankBranchID(String bankBranchID) {
    this.bankBranchID = bankBranchID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setBrokerID(String brokerID) {
    this.brokerID = brokerID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setBrokerBranchID(String brokerBranchID) {
    this.brokerBranchID = brokerBranchID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setTradeDate(String tradeDate) {
    this.tradeDate = tradeDate;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setTradeTime(String tradeTime) {
    this.tradeTime = tradeTime;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setBankSerial(String bankSerial) {
    this.bankSerial = bankSerial;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setTradingDay(String tradingDay) {
    this.tradingDay = tradingDay;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setPlateSerial(int plateSerial) {
    this.plateSerial = plateSerial;
    setPlateSerialIsSet(true);
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setLastFragment(String lastFragment) {
    this.lastFragment = lastFragment;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setSessionID(int sessionID) {
    this.sessionID = sessionID;
    setSessionIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setInstallID(int installID) {
    this.installID = installID;
    setInstallIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setUserID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setDigest(String digest) {
    this.digest = digest;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setCurrencyID(String currencyID) {
    this.currencyID = currencyID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setDeviceID(String deviceID) {
    this.deviceID = deviceID;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setBrokerIDByBank(String brokerIDByBank) {
    this.brokerIDByBank = brokerIDByBank;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setOperNo(String operNo) {
    this.operNo = operNo;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setRequestID(int requestID) {
    this.requestID = requestID;
    setRequestIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setTID(int tID) {
    this.tID = tID;
    setTIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setErrorID(int errorID) {
    this.errorID = errorID;
    setErrorIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setErrorMsg(String errorMsg) {
    this.errorMsg = errorMsg;
    return this;
  }
  ...
  public CThostFtdcNotifyFutureSignInField setPinKey(String pinKey) {
    this.pinKey = pinKey;
    return this;
  }

  public void unsetPinKey() {
    this.pinKey = null;
  }

  /** Returns true if field pinKey is set (has been assigned a value) and false otherwise */
  public boolean isSetPinKey() {
    return this.pinKey != null;
  }

  public void setPinKeyIsSet(boolean value) {
    if (!value) {
      this.pinKey = null;
    }
  }
  ...
  public CThostFtdcNotifyFutureSignInField setMacKey(String macKey) {
    this.macKey = macKey;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CThostFtdcNotifyFutureSignInField)
      return this.equals((CThostFtdcNotifyFutureSignInField)that);
    return false;
  }

  public boolean equals(CThostFtdcNotifyFutureSignInField that) {
    if (that == null)
      return false;
    ...
    boolean this_present_pinKey = true && this.isSetPinKey();
    boolean that_present_pinKey = true && that.isSetPinKey();
    if (this_present_pinKey || that_present_pinKey) {
      if (!(this_present_pinKey && that_present_pinKey))
        return false;
      if (!this.pinKey.equals(that.pinKey))
        return false;
    }
  ...
  @Override
  public int compareTo(CThostFtdcNotifyFutureSignInField other) {
    ...
    lastComparison = Boolean.valueOf(isSetPinKey()).compareTo(other.isSetPinKey());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPinKey()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.pinKey, other.pinKey);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetMacKey()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.macKey, other.macKey);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CThostFtdcNotifyFutureSignInField(");
    boolean first = true;
  ...
  private static class CThostFtdcNotifyFutureSignInFieldStandardSchemeFactory implements SchemeFactory {
    public CThostFtdcNotifyFutureSignInFieldStandardScheme getScheme() {
      return new CThostFtdcNotifyFutureSignInFieldStandardScheme();
    }
  }

  private static class CThostFtdcNotifyFutureSignInFieldStandardScheme extends StandardScheme<CThostFtdcNotifyFutureSignInField> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CThostFtdcNotifyFutureSignInField struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 24: // PIN_KEY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.pinKey = iprot.readString();
              struct.setPinKeyIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CThostFtdcNotifyFutureSignInField struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.pinKey != null) {
        oprot.writeFieldBegin(PIN_KEY_FIELD_DESC);
        oprot.writeString(struct.pinKey);
        oprot.writeFieldEnd();
      }
  ...
  private static class CThostFtdcNotifyFutureSignInFieldTupleSchemeFactory implements SchemeFactory {
    public CThostFtdcNotifyFutureSignInFieldTupleScheme getScheme() {
      return new CThostFtdcNotifyFutureSignInFieldTupleScheme();
    }
  }

  private static class CThostFtdcNotifyFutureSignInFieldTupleScheme extends TupleScheme<CThostFtdcNotifyFutureSignInField> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CThostFtdcNotifyFutureSignInField struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CThostFtdcNotifyFutureSignInField struct) throws org.apache.thrift.TException {
