...
public class InvestorFieldResponse implements org.apache.thrift.TBase<InvestorFieldResponse, InvestorFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InvestorFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InvestorFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_INVESTOR_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcInvestorField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new InvestorFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InvestorFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField cThostFtdcInvestorField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_INVESTOR_FIELD((short)1, "cThostFtdcInvestorField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_INVESTOR_FIELD
          return C_THOST_FTDC_INVESTOR_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_INVESTOR_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcInvestorField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InvestorFieldResponse.class, metaDataMap);
  }

  public InvestorFieldResponse() {
  }

  public InvestorFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField cThostFtdcInvestorField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcInvestorField = cThostFtdcInvestorField;
   ...
   */
  public InvestorFieldResponse(InvestorFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcInvestorField()) {
      this.cThostFtdcInvestorField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField(other.cThostFtdcInvestorField);
    }
  ...
  public InvestorFieldResponse deepCopy() {
    return new InvestorFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcInvestorField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField getCThostFtdcInvestorField() {
    return this.cThostFtdcInvestorField;
  }

  public InvestorFieldResponse setCThostFtdcInvestorField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField cThostFtdcInvestorField) {
    this.cThostFtdcInvestorField = cThostFtdcInvestorField;
    return this;
  }

  public void unsetCThostFtdcInvestorField() {
    this.cThostFtdcInvestorField = null;
  }

  /** Returns true if field cThostFtdcInvestorField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcInvestorField() {
    return this.cThostFtdcInvestorField != null;
  }

  public void setCThostFtdcInvestorFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcInvestorField = null;
    }
  }
  ...
  public InvestorFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InvestorFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InvestorFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_INVESTOR_FIELD:
      if (value == null) {
        unsetCThostFtdcInvestorField();
      } else {
        setCThostFtdcInvestorField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_INVESTOR_FIELD:
      return getCThostFtdcInvestorField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_INVESTOR_FIELD:
      return isSetCThostFtdcInvestorField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InvestorFieldResponse)
      return this.equals((InvestorFieldResponse)that);
    return false;
  }

  public boolean equals(InvestorFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcInvestorField = true && this.isSetCThostFtdcInvestorField();
    boolean that_present_cThostFtdcInvestorField = true && that.isSetCThostFtdcInvestorField();
    if (this_present_cThostFtdcInvestorField || that_present_cThostFtdcInvestorField) {
      if (!(this_present_cThostFtdcInvestorField && that_present_cThostFtdcInvestorField))
        return false;
      if (!this.cThostFtdcInvestorField.equals(that.cThostFtdcInvestorField))
        return false;
    }
  ...
  @Override
  public int compareTo(InvestorFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcInvestorField()).compareTo(other.isSetCThostFtdcInvestorField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcInvestorField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcInvestorField, other.cThostFtdcInvestorField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InvestorFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcInvestorField:");
    if (this.cThostFtdcInvestorField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcInvestorField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcInvestorField != null) {
      cThostFtdcInvestorField.validate();
    }
  ...
  private static class InvestorFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InvestorFieldResponseStandardScheme getScheme() {
      return new InvestorFieldResponseStandardScheme();
    }
  }

  private static class InvestorFieldResponseStandardScheme extends StandardScheme<InvestorFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InvestorFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_INVESTOR_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcInvestorField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcInvestorField();
              struct.cThostFtdcInvestorField.read(iprot);
              struct.setCThostFtdcInvestorFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InvestorFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcInvestorField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_INVESTOR_FIELD_FIELD_DESC);
        struct.cThostFtdcInvestorField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class InvestorFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InvestorFieldResponseTupleScheme getScheme() {
      return new InvestorFieldResponseTupleScheme();
    }
  }

  private static class InvestorFieldResponseTupleScheme extends TupleScheme<InvestorFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InvestorFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcInvestorField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InvestorFieldResponse struct) throws org.apache.thrift.TException {
