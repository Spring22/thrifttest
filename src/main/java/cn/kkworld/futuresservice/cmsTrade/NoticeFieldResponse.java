...
public class NoticeFieldResponse implements org.apache.thrift.TBase<NoticeFieldResponse, NoticeFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<NoticeFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NoticeFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_NOTICE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcNoticeField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new NoticeFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NoticeFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField cThostFtdcNoticeField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_NOTICE_FIELD((short)1, "cThostFtdcNoticeField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_NOTICE_FIELD
          return C_THOST_FTDC_NOTICE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_NOTICE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcNoticeField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NoticeFieldResponse.class, metaDataMap);
  }

  public NoticeFieldResponse() {
  }

  public NoticeFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField cThostFtdcNoticeField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcNoticeField = cThostFtdcNoticeField;
   ...
   */
  public NoticeFieldResponse(NoticeFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcNoticeField()) {
      this.cThostFtdcNoticeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField(other.cThostFtdcNoticeField);
    }
  ...
  public NoticeFieldResponse deepCopy() {
    return new NoticeFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcNoticeField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField getCThostFtdcNoticeField() {
    return this.cThostFtdcNoticeField;
  }

  public NoticeFieldResponse setCThostFtdcNoticeField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField cThostFtdcNoticeField) {
    this.cThostFtdcNoticeField = cThostFtdcNoticeField;
    return this;
  }

  public void unsetCThostFtdcNoticeField() {
    this.cThostFtdcNoticeField = null;
  }

  /** Returns true if field cThostFtdcNoticeField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcNoticeField() {
    return this.cThostFtdcNoticeField != null;
  }

  public void setCThostFtdcNoticeFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcNoticeField = null;
    }
  }
  ...
  public NoticeFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public NoticeFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public NoticeFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_NOTICE_FIELD:
      if (value == null) {
        unsetCThostFtdcNoticeField();
      } else {
        setCThostFtdcNoticeField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_NOTICE_FIELD:
      return getCThostFtdcNoticeField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_NOTICE_FIELD:
      return isSetCThostFtdcNoticeField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NoticeFieldResponse)
      return this.equals((NoticeFieldResponse)that);
    return false;
  }

  public boolean equals(NoticeFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcNoticeField = true && this.isSetCThostFtdcNoticeField();
    boolean that_present_cThostFtdcNoticeField = true && that.isSetCThostFtdcNoticeField();
    if (this_present_cThostFtdcNoticeField || that_present_cThostFtdcNoticeField) {
      if (!(this_present_cThostFtdcNoticeField && that_present_cThostFtdcNoticeField))
        return false;
      if (!this.cThostFtdcNoticeField.equals(that.cThostFtdcNoticeField))
        return false;
    }
  ...
  @Override
  public int compareTo(NoticeFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcNoticeField()).compareTo(other.isSetCThostFtdcNoticeField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcNoticeField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcNoticeField, other.cThostFtdcNoticeField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NoticeFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcNoticeField:");
    if (this.cThostFtdcNoticeField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcNoticeField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcNoticeField != null) {
      cThostFtdcNoticeField.validate();
    }
  ...
  private static class NoticeFieldResponseStandardSchemeFactory implements SchemeFactory {
    public NoticeFieldResponseStandardScheme getScheme() {
      return new NoticeFieldResponseStandardScheme();
    }
  }

  private static class NoticeFieldResponseStandardScheme extends StandardScheme<NoticeFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NoticeFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_NOTICE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcNoticeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcNoticeField();
              struct.cThostFtdcNoticeField.read(iprot);
              struct.setCThostFtdcNoticeFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NoticeFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcNoticeField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_NOTICE_FIELD_FIELD_DESC);
        struct.cThostFtdcNoticeField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class NoticeFieldResponseTupleSchemeFactory implements SchemeFactory {
    public NoticeFieldResponseTupleScheme getScheme() {
      return new NoticeFieldResponseTupleScheme();
    }
  }

  private static class NoticeFieldResponseTupleScheme extends TupleScheme<NoticeFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NoticeFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcNoticeField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NoticeFieldResponse struct) throws org.apache.thrift.TException {
