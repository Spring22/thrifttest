...
public class InputExecOrderFieldResponse implements org.apache.thrift.TBase<InputExecOrderFieldResponse, InputExecOrderFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<InputExecOrderFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InputExecOrderFieldResponse");

  private static final org.apache.thrift.protocol.TField CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("CThostFtdcInputExecOrderField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new InputExecOrderFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InputExecOrderFieldResponseTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD((short)1, "CThostFtdcInputExecOrderField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD
          return CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD, new org.apache.thrift.meta_data.FieldMetaData("CThostFtdcInputExecOrderField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InputExecOrderFieldResponse.class, metaDataMap);
  }

  public InputExecOrderFieldResponse() {
  }
   ...
   */
  public InputExecOrderFieldResponse(InputExecOrderFieldResponse other) {
  ...
  public InputExecOrderFieldResponse deepCopy() {
    return new InputExecOrderFieldResponse(this);
  }
  ...
  public InputExecOrderFieldResponse setCThostFtdcInputExecOrderField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcInputExecOrderField CThostFtdcInputExecOrderField) {
    this.CThostFtdcInputExecOrderField = CThostFtdcInputExecOrderField;
    return this;
  }
  ...
  public InputExecOrderFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public InputExecOrderFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public InputExecOrderFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD:
      if (value == null) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InputExecOrderFieldResponse)
      return this.equals((InputExecOrderFieldResponse)that);
    return false;
  }

  public boolean equals(InputExecOrderFieldResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(InputExecOrderFieldResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InputExecOrderFieldResponse(");
    boolean first = true;
  ...
  private static class InputExecOrderFieldResponseStandardSchemeFactory implements SchemeFactory {
    public InputExecOrderFieldResponseStandardScheme getScheme() {
      return new InputExecOrderFieldResponseStandardScheme();
    }
  }

  private static class InputExecOrderFieldResponseStandardScheme extends StandardScheme<InputExecOrderFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InputExecOrderFieldResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InputExecOrderFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.CThostFtdcInputExecOrderField != null) {
        oprot.writeFieldBegin(CTHOST_FTDC_INPUT_EXEC_ORDER_FIELD_FIELD_DESC);
  ...
  private static class InputExecOrderFieldResponseTupleSchemeFactory implements SchemeFactory {
    public InputExecOrderFieldResponseTupleScheme getScheme() {
      return new InputExecOrderFieldResponseTupleScheme();
    }
  }

  private static class InputExecOrderFieldResponseTupleScheme extends TupleScheme<InputExecOrderFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InputExecOrderFieldResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InputExecOrderFieldResponse struct) throws org.apache.thrift.TException {
