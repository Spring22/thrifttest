...
public class UserLogoutResponse implements org.apache.thrift.TBase<UserLogoutResponse, UserLogoutResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UserLogoutResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserLogoutResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_USER_LOGOUT_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcUserLogoutField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new UserLogoutResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserLogoutResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField cThostFtdcUserLogoutField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_USER_LOGOUT_FIELD((short)1, "cThostFtdcUserLogoutField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_USER_LOGOUT_FIELD
          return C_THOST_FTDC_USER_LOGOUT_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_USER_LOGOUT_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcUserLogoutField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserLogoutResponse.class, metaDataMap);
  }
  ...
  public UserLogoutResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField cThostFtdcUserLogoutField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcUserLogoutField = cThostFtdcUserLogoutField;
   ...
   */
  public UserLogoutResponse(UserLogoutResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcUserLogoutField()) {
      this.cThostFtdcUserLogoutField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField(other.cThostFtdcUserLogoutField);
    }
  ...
  public UserLogoutResponse deepCopy() {
    return new UserLogoutResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcUserLogoutField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField getCThostFtdcUserLogoutField() {
    return this.cThostFtdcUserLogoutField;
  }

  public UserLogoutResponse setCThostFtdcUserLogoutField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField cThostFtdcUserLogoutField) {
    this.cThostFtdcUserLogoutField = cThostFtdcUserLogoutField;
    return this;
  }

  public void unsetCThostFtdcUserLogoutField() {
    this.cThostFtdcUserLogoutField = null;
  }

  /** Returns true if field cThostFtdcUserLogoutField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcUserLogoutField() {
    return this.cThostFtdcUserLogoutField != null;
  }

  public void setCThostFtdcUserLogoutFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcUserLogoutField = null;
    }
  }
  ...
  public UserLogoutResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public UserLogoutResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public UserLogoutResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_USER_LOGOUT_FIELD:
      if (value == null) {
        unsetCThostFtdcUserLogoutField();
      } else {
        setCThostFtdcUserLogoutField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_USER_LOGOUT_FIELD:
      return getCThostFtdcUserLogoutField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_USER_LOGOUT_FIELD:
      return isSetCThostFtdcUserLogoutField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserLogoutResponse)
      return this.equals((UserLogoutResponse)that);
    return false;
  }

  public boolean equals(UserLogoutResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcUserLogoutField = true && this.isSetCThostFtdcUserLogoutField();
    boolean that_present_cThostFtdcUserLogoutField = true && that.isSetCThostFtdcUserLogoutField();
    if (this_present_cThostFtdcUserLogoutField || that_present_cThostFtdcUserLogoutField) {
      if (!(this_present_cThostFtdcUserLogoutField && that_present_cThostFtdcUserLogoutField))
        return false;
      if (!this.cThostFtdcUserLogoutField.equals(that.cThostFtdcUserLogoutField))
        return false;
    }
  ...
  @Override
  public int compareTo(UserLogoutResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcUserLogoutField()).compareTo(other.isSetCThostFtdcUserLogoutField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcUserLogoutField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcUserLogoutField, other.cThostFtdcUserLogoutField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserLogoutResponse(");
    boolean first = true;

    sb.append("cThostFtdcUserLogoutField:");
    if (this.cThostFtdcUserLogoutField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcUserLogoutField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcUserLogoutField != null) {
      cThostFtdcUserLogoutField.validate();
    }
  ...
  private static class UserLogoutResponseStandardSchemeFactory implements SchemeFactory {
    public UserLogoutResponseStandardScheme getScheme() {
      return new UserLogoutResponseStandardScheme();
    }
  }

  private static class UserLogoutResponseStandardScheme extends StandardScheme<UserLogoutResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserLogoutResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_USER_LOGOUT_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcUserLogoutField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcUserLogoutField();
              struct.cThostFtdcUserLogoutField.read(iprot);
              struct.setCThostFtdcUserLogoutFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserLogoutResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcUserLogoutField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_USER_LOGOUT_FIELD_FIELD_DESC);
        struct.cThostFtdcUserLogoutField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class UserLogoutResponseTupleSchemeFactory implements SchemeFactory {
    public UserLogoutResponseTupleScheme getScheme() {
      return new UserLogoutResponseTupleScheme();
    }
  }

  private static class UserLogoutResponseTupleScheme extends TupleScheme<UserLogoutResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserLogoutResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcUserLogoutField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserLogoutResponse struct) throws org.apache.thrift.TException {
