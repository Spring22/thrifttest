...
public class OrderFieldResponse implements org.apache.thrift.TBase<OrderFieldResponse, OrderFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<OrderFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrderFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_ORDER_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcOrderField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new OrderFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrderFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField cThostFtdcOrderField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_ORDER_FIELD((short)1, "cThostFtdcOrderField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_ORDER_FIELD
          return C_THOST_FTDC_ORDER_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_ORDER_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcOrderField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrderFieldResponse.class, metaDataMap);
  }

  public OrderFieldResponse() {
  }

  public OrderFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField cThostFtdcOrderField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcOrderField = cThostFtdcOrderField;
   ...
   */
  public OrderFieldResponse(OrderFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcOrderField()) {
      this.cThostFtdcOrderField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField(other.cThostFtdcOrderField);
    }
  ...
  public OrderFieldResponse deepCopy() {
    return new OrderFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcOrderField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField getCThostFtdcOrderField() {
    return this.cThostFtdcOrderField;
  }

  public OrderFieldResponse setCThostFtdcOrderField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField cThostFtdcOrderField) {
    this.cThostFtdcOrderField = cThostFtdcOrderField;
    return this;
  }

  public void unsetCThostFtdcOrderField() {
    this.cThostFtdcOrderField = null;
  }

  /** Returns true if field cThostFtdcOrderField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcOrderField() {
    return this.cThostFtdcOrderField != null;
  }

  public void setCThostFtdcOrderFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcOrderField = null;
    }
  }
  ...
  public OrderFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public OrderFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public OrderFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_ORDER_FIELD:
      if (value == null) {
        unsetCThostFtdcOrderField();
      } else {
        setCThostFtdcOrderField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_ORDER_FIELD:
      return getCThostFtdcOrderField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_ORDER_FIELD:
      return isSetCThostFtdcOrderField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrderFieldResponse)
      return this.equals((OrderFieldResponse)that);
    return false;
  }

  public boolean equals(OrderFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcOrderField = true && this.isSetCThostFtdcOrderField();
    boolean that_present_cThostFtdcOrderField = true && that.isSetCThostFtdcOrderField();
    if (this_present_cThostFtdcOrderField || that_present_cThostFtdcOrderField) {
      if (!(this_present_cThostFtdcOrderField && that_present_cThostFtdcOrderField))
        return false;
      if (!this.cThostFtdcOrderField.equals(that.cThostFtdcOrderField))
        return false;
    }
  ...
  @Override
  public int compareTo(OrderFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcOrderField()).compareTo(other.isSetCThostFtdcOrderField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcOrderField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcOrderField, other.cThostFtdcOrderField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrderFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcOrderField:");
    if (this.cThostFtdcOrderField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcOrderField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class OrderFieldResponseStandardSchemeFactory implements SchemeFactory {
    public OrderFieldResponseStandardScheme getScheme() {
      return new OrderFieldResponseStandardScheme();
    }
  }

  private static class OrderFieldResponseStandardScheme extends StandardScheme<OrderFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrderFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_ORDER_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcOrderField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcOrderField();
              struct.cThostFtdcOrderField.read(iprot);
              struct.setCThostFtdcOrderFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrderFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcOrderField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_ORDER_FIELD_FIELD_DESC);
        struct.cThostFtdcOrderField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class OrderFieldResponseTupleSchemeFactory implements SchemeFactory {
    public OrderFieldResponseTupleScheme getScheme() {
      return new OrderFieldResponseTupleScheme();
    }
  }

  private static class OrderFieldResponseTupleScheme extends TupleScheme<OrderFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrderFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcOrderField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrderFieldResponse struct) throws org.apache.thrift.TException {
