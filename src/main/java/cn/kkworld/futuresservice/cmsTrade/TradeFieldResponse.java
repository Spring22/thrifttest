...
public class TradeFieldResponse implements org.apache.thrift.TBase<TradeFieldResponse, TradeFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TradeFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TradeFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_TRADE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcTradeField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new TradeFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TradeFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField cThostFtdcTradeField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_TRADE_FIELD((short)1, "cThostFtdcTradeField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_TRADE_FIELD
          return C_THOST_FTDC_TRADE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_TRADE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcTradeField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TradeFieldResponse.class, metaDataMap);
  }

  public TradeFieldResponse() {
  }

  public TradeFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField cThostFtdcTradeField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcTradeField = cThostFtdcTradeField;
   ...
   */
  public TradeFieldResponse(TradeFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcTradeField()) {
      this.cThostFtdcTradeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField(other.cThostFtdcTradeField);
    }
  ...
  public TradeFieldResponse deepCopy() {
    return new TradeFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcTradeField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField getCThostFtdcTradeField() {
    return this.cThostFtdcTradeField;
  }

  public TradeFieldResponse setCThostFtdcTradeField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField cThostFtdcTradeField) {
    this.cThostFtdcTradeField = cThostFtdcTradeField;
    return this;
  }

  public void unsetCThostFtdcTradeField() {
    this.cThostFtdcTradeField = null;
  }

  /** Returns true if field cThostFtdcTradeField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcTradeField() {
    return this.cThostFtdcTradeField != null;
  }

  public void setCThostFtdcTradeFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcTradeField = null;
    }
  }
  ...
  public TradeFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public TradeFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public TradeFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_TRADE_FIELD:
      if (value == null) {
        unsetCThostFtdcTradeField();
      } else {
        setCThostFtdcTradeField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_TRADE_FIELD:
      return getCThostFtdcTradeField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_TRADE_FIELD:
      return isSetCThostFtdcTradeField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TradeFieldResponse)
      return this.equals((TradeFieldResponse)that);
    return false;
  }

  public boolean equals(TradeFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcTradeField = true && this.isSetCThostFtdcTradeField();
    boolean that_present_cThostFtdcTradeField = true && that.isSetCThostFtdcTradeField();
    if (this_present_cThostFtdcTradeField || that_present_cThostFtdcTradeField) {
      if (!(this_present_cThostFtdcTradeField && that_present_cThostFtdcTradeField))
        return false;
      if (!this.cThostFtdcTradeField.equals(that.cThostFtdcTradeField))
        return false;
    }
  ...
  @Override
  public int compareTo(TradeFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcTradeField()).compareTo(other.isSetCThostFtdcTradeField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcTradeField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcTradeField, other.cThostFtdcTradeField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TradeFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcTradeField:");
    if (this.cThostFtdcTradeField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcTradeField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class TradeFieldResponseStandardSchemeFactory implements SchemeFactory {
    public TradeFieldResponseStandardScheme getScheme() {
      return new TradeFieldResponseStandardScheme();
    }
  }

  private static class TradeFieldResponseStandardScheme extends StandardScheme<TradeFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TradeFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_TRADE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcTradeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradeField();
              struct.cThostFtdcTradeField.read(iprot);
              struct.setCThostFtdcTradeFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TradeFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcTradeField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_TRADE_FIELD_FIELD_DESC);
        struct.cThostFtdcTradeField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class TradeFieldResponseTupleSchemeFactory implements SchemeFactory {
    public TradeFieldResponseTupleScheme getScheme() {
      return new TradeFieldResponseTupleScheme();
    }
  }

  private static class TradeFieldResponseTupleScheme extends TupleScheme<TradeFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TradeFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcTradeField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TradeFieldResponse struct) throws org.apache.thrift.TException {
