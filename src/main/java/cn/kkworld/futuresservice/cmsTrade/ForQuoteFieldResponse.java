...
public class ForQuoteFieldResponse implements org.apache.thrift.TBase<ForQuoteFieldResponse, ForQuoteFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ForQuoteFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ForQuoteFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_FOR_QUOTE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcForQuoteField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ForQuoteFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ForQuoteFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField cThostFtdcForQuoteField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_FOR_QUOTE_FIELD((short)1, "cThostFtdcForQuoteField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_FOR_QUOTE_FIELD
          return C_THOST_FTDC_FOR_QUOTE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_FOR_QUOTE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcForQuoteField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ForQuoteFieldResponse.class, metaDataMap);
  }

  public ForQuoteFieldResponse() {
  }

  public ForQuoteFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField cThostFtdcForQuoteField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcForQuoteField = cThostFtdcForQuoteField;
   ...
   */
  public ForQuoteFieldResponse(ForQuoteFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcForQuoteField()) {
      this.cThostFtdcForQuoteField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField(other.cThostFtdcForQuoteField);
    }
  ...
  public ForQuoteFieldResponse deepCopy() {
    return new ForQuoteFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcForQuoteField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField getCThostFtdcForQuoteField() {
    return this.cThostFtdcForQuoteField;
  }

  public ForQuoteFieldResponse setCThostFtdcForQuoteField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField cThostFtdcForQuoteField) {
    this.cThostFtdcForQuoteField = cThostFtdcForQuoteField;
    return this;
  }

  public void unsetCThostFtdcForQuoteField() {
    this.cThostFtdcForQuoteField = null;
  }

  /** Returns true if field cThostFtdcForQuoteField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcForQuoteField() {
    return this.cThostFtdcForQuoteField != null;
  }

  public void setCThostFtdcForQuoteFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcForQuoteField = null;
    }
  }
  ...
  public ForQuoteFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ForQuoteFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ForQuoteFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_FOR_QUOTE_FIELD:
      if (value == null) {
        unsetCThostFtdcForQuoteField();
      } else {
        setCThostFtdcForQuoteField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_FOR_QUOTE_FIELD:
      return getCThostFtdcForQuoteField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_FOR_QUOTE_FIELD:
      return isSetCThostFtdcForQuoteField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ForQuoteFieldResponse)
      return this.equals((ForQuoteFieldResponse)that);
    return false;
  }

  public boolean equals(ForQuoteFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcForQuoteField = true && this.isSetCThostFtdcForQuoteField();
    boolean that_present_cThostFtdcForQuoteField = true && that.isSetCThostFtdcForQuoteField();
    if (this_present_cThostFtdcForQuoteField || that_present_cThostFtdcForQuoteField) {
      if (!(this_present_cThostFtdcForQuoteField && that_present_cThostFtdcForQuoteField))
        return false;
      if (!this.cThostFtdcForQuoteField.equals(that.cThostFtdcForQuoteField))
        return false;
    }
  ...
  @Override
  public int compareTo(ForQuoteFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcForQuoteField()).compareTo(other.isSetCThostFtdcForQuoteField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcForQuoteField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcForQuoteField, other.cThostFtdcForQuoteField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ForQuoteFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcForQuoteField:");
    if (this.cThostFtdcForQuoteField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcForQuoteField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcForQuoteField != null) {
      cThostFtdcForQuoteField.validate();
    }
  ...
  private static class ForQuoteFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ForQuoteFieldResponseStandardScheme getScheme() {
      return new ForQuoteFieldResponseStandardScheme();
    }
  }

  private static class ForQuoteFieldResponseStandardScheme extends StandardScheme<ForQuoteFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ForQuoteFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_FOR_QUOTE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcForQuoteField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcForQuoteField();
              struct.cThostFtdcForQuoteField.read(iprot);
              struct.setCThostFtdcForQuoteFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ForQuoteFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcForQuoteField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_FOR_QUOTE_FIELD_FIELD_DESC);
        struct.cThostFtdcForQuoteField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ForQuoteFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ForQuoteFieldResponseTupleScheme getScheme() {
      return new ForQuoteFieldResponseTupleScheme();
    }
  }

  private static class ForQuoteFieldResponseTupleScheme extends TupleScheme<ForQuoteFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ForQuoteFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcForQuoteField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ForQuoteFieldResponse struct) throws org.apache.thrift.TException {
