...
public class ParkedOrderFieldResponse implements org.apache.thrift.TBase<ParkedOrderFieldResponse, ParkedOrderFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ParkedOrderFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ParkedOrderFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_PARKED_ORDER_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcParkedOrderField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ParkedOrderFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ParkedOrderFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField cThostFtdcParkedOrderField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_PARKED_ORDER_FIELD((short)1, "cThostFtdcParkedOrderField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_PARKED_ORDER_FIELD
          return C_THOST_FTDC_PARKED_ORDER_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_PARKED_ORDER_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcParkedOrderField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ParkedOrderFieldResponse.class, metaDataMap);
  }

  public ParkedOrderFieldResponse() {
  }

  public ParkedOrderFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField cThostFtdcParkedOrderField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcParkedOrderField = cThostFtdcParkedOrderField;
   ...
   */
  public ParkedOrderFieldResponse(ParkedOrderFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcParkedOrderField()) {
      this.cThostFtdcParkedOrderField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField(other.cThostFtdcParkedOrderField);
    }
  ...
  public ParkedOrderFieldResponse deepCopy() {
    return new ParkedOrderFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcParkedOrderField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField getCThostFtdcParkedOrderField() {
    return this.cThostFtdcParkedOrderField;
  }

  public ParkedOrderFieldResponse setCThostFtdcParkedOrderField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField cThostFtdcParkedOrderField) {
    this.cThostFtdcParkedOrderField = cThostFtdcParkedOrderField;
    return this;
  }

  public void unsetCThostFtdcParkedOrderField() {
    this.cThostFtdcParkedOrderField = null;
  }

  /** Returns true if field cThostFtdcParkedOrderField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcParkedOrderField() {
    return this.cThostFtdcParkedOrderField != null;
  }

  public void setCThostFtdcParkedOrderFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcParkedOrderField = null;
    }
  }
  ...
  public ParkedOrderFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ParkedOrderFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ParkedOrderFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_PARKED_ORDER_FIELD:
      if (value == null) {
        unsetCThostFtdcParkedOrderField();
      } else {
        setCThostFtdcParkedOrderField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_PARKED_ORDER_FIELD:
      return getCThostFtdcParkedOrderField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_PARKED_ORDER_FIELD:
      return isSetCThostFtdcParkedOrderField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ParkedOrderFieldResponse)
      return this.equals((ParkedOrderFieldResponse)that);
    return false;
  }

  public boolean equals(ParkedOrderFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcParkedOrderField = true && this.isSetCThostFtdcParkedOrderField();
    boolean that_present_cThostFtdcParkedOrderField = true && that.isSetCThostFtdcParkedOrderField();
    if (this_present_cThostFtdcParkedOrderField || that_present_cThostFtdcParkedOrderField) {
      if (!(this_present_cThostFtdcParkedOrderField && that_present_cThostFtdcParkedOrderField))
        return false;
      if (!this.cThostFtdcParkedOrderField.equals(that.cThostFtdcParkedOrderField))
        return false;
    }
  ...
  @Override
  public int compareTo(ParkedOrderFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcParkedOrderField()).compareTo(other.isSetCThostFtdcParkedOrderField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcParkedOrderField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcParkedOrderField, other.cThostFtdcParkedOrderField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ParkedOrderFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcParkedOrderField:");
    if (this.cThostFtdcParkedOrderField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcParkedOrderField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcParkedOrderField != null) {
      cThostFtdcParkedOrderField.validate();
    }
  ...
  private static class ParkedOrderFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ParkedOrderFieldResponseStandardScheme getScheme() {
      return new ParkedOrderFieldResponseStandardScheme();
    }
  }

  private static class ParkedOrderFieldResponseStandardScheme extends StandardScheme<ParkedOrderFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ParkedOrderFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_PARKED_ORDER_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcParkedOrderField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderField();
              struct.cThostFtdcParkedOrderField.read(iprot);
              struct.setCThostFtdcParkedOrderFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ParkedOrderFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcParkedOrderField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_PARKED_ORDER_FIELD_FIELD_DESC);
        struct.cThostFtdcParkedOrderField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ParkedOrderFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ParkedOrderFieldResponseTupleScheme getScheme() {
      return new ParkedOrderFieldResponseTupleScheme();
    }
  }

  private static class ParkedOrderFieldResponseTupleScheme extends TupleScheme<ParkedOrderFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ParkedOrderFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcParkedOrderField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ParkedOrderFieldResponse struct) throws org.apache.thrift.TException {
