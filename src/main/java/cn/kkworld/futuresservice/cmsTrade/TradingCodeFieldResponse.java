...
public class TradingCodeFieldResponse implements org.apache.thrift.TBase<TradingCodeFieldResponse, TradingCodeFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TradingCodeFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TradingCodeFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_TRADING_CODE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcTradingCodeField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new TradingCodeFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TradingCodeFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField cThostFtdcTradingCodeField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_TRADING_CODE_FIELD((short)1, "cThostFtdcTradingCodeField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_TRADING_CODE_FIELD
          return C_THOST_FTDC_TRADING_CODE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_TRADING_CODE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcTradingCodeField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TradingCodeFieldResponse.class, metaDataMap);
  }

  public TradingCodeFieldResponse() {
  }

  public TradingCodeFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField cThostFtdcTradingCodeField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcTradingCodeField = cThostFtdcTradingCodeField;
   ...
   */
  public TradingCodeFieldResponse(TradingCodeFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcTradingCodeField()) {
      this.cThostFtdcTradingCodeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField(other.cThostFtdcTradingCodeField);
    }
  ...
  public TradingCodeFieldResponse deepCopy() {
    return new TradingCodeFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcTradingCodeField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField getCThostFtdcTradingCodeField() {
    return this.cThostFtdcTradingCodeField;
  }

  public TradingCodeFieldResponse setCThostFtdcTradingCodeField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField cThostFtdcTradingCodeField) {
    this.cThostFtdcTradingCodeField = cThostFtdcTradingCodeField;
    return this;
  }

  public void unsetCThostFtdcTradingCodeField() {
    this.cThostFtdcTradingCodeField = null;
  }

  /** Returns true if field cThostFtdcTradingCodeField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcTradingCodeField() {
    return this.cThostFtdcTradingCodeField != null;
  }

  public void setCThostFtdcTradingCodeFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcTradingCodeField = null;
    }
  }
  ...
  public TradingCodeFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public TradingCodeFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public TradingCodeFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_TRADING_CODE_FIELD:
      if (value == null) {
        unsetCThostFtdcTradingCodeField();
      } else {
        setCThostFtdcTradingCodeField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_TRADING_CODE_FIELD:
      return getCThostFtdcTradingCodeField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_TRADING_CODE_FIELD:
      return isSetCThostFtdcTradingCodeField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TradingCodeFieldResponse)
      return this.equals((TradingCodeFieldResponse)that);
    return false;
  }

  public boolean equals(TradingCodeFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcTradingCodeField = true && this.isSetCThostFtdcTradingCodeField();
    boolean that_present_cThostFtdcTradingCodeField = true && that.isSetCThostFtdcTradingCodeField();
    if (this_present_cThostFtdcTradingCodeField || that_present_cThostFtdcTradingCodeField) {
      if (!(this_present_cThostFtdcTradingCodeField && that_present_cThostFtdcTradingCodeField))
        return false;
      if (!this.cThostFtdcTradingCodeField.equals(that.cThostFtdcTradingCodeField))
        return false;
    }
  ...
  @Override
  public int compareTo(TradingCodeFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcTradingCodeField()).compareTo(other.isSetCThostFtdcTradingCodeField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcTradingCodeField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcTradingCodeField, other.cThostFtdcTradingCodeField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TradingCodeFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcTradingCodeField:");
    if (this.cThostFtdcTradingCodeField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcTradingCodeField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcTradingCodeField != null) {
      cThostFtdcTradingCodeField.validate();
    }
  ...
  private static class TradingCodeFieldResponseStandardSchemeFactory implements SchemeFactory {
    public TradingCodeFieldResponseStandardScheme getScheme() {
      return new TradingCodeFieldResponseStandardScheme();
    }
  }

  private static class TradingCodeFieldResponseStandardScheme extends StandardScheme<TradingCodeFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TradingCodeFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_TRADING_CODE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcTradingCodeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingCodeField();
              struct.cThostFtdcTradingCodeField.read(iprot);
              struct.setCThostFtdcTradingCodeFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TradingCodeFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcTradingCodeField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_TRADING_CODE_FIELD_FIELD_DESC);
        struct.cThostFtdcTradingCodeField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class TradingCodeFieldResponseTupleSchemeFactory implements SchemeFactory {
    public TradingCodeFieldResponseTupleScheme getScheme() {
      return new TradingCodeFieldResponseTupleScheme();
    }
  }

  private static class TradingCodeFieldResponseTupleScheme extends TupleScheme<TradingCodeFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TradingCodeFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcTradingCodeField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TradingCodeFieldResponse struct) throws org.apache.thrift.TException {
