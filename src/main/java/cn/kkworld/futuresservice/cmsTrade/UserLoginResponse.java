 ...
 * 
 */
public class UserLoginResponse implements org.apache.thrift.TBase<UserLoginResponse, UserLoginResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UserLoginResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UserLoginResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_RSP_USER_LOGIN_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcRspUserLoginField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new UserLoginResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new UserLoginResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField cThostFtdcRspUserLoginField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_RSP_USER_LOGIN_FIELD((short)1, "cThostFtdcRspUserLoginField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_RSP_USER_LOGIN_FIELD
          return C_THOST_FTDC_RSP_USER_LOGIN_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_RSP_USER_LOGIN_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcRspUserLoginField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UserLoginResponse.class, metaDataMap);
  }
  ...
  public UserLoginResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField cThostFtdcRspUserLoginField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcRspUserLoginField = cThostFtdcRspUserLoginField;
   ...
   */
  public UserLoginResponse(UserLoginResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcRspUserLoginField()) {
      this.cThostFtdcRspUserLoginField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField(other.cThostFtdcRspUserLoginField);
    }
  ...
  public UserLoginResponse deepCopy() {
    return new UserLoginResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcRspUserLoginField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField getCThostFtdcRspUserLoginField() {
    return this.cThostFtdcRspUserLoginField;
  }

  public UserLoginResponse setCThostFtdcRspUserLoginField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField cThostFtdcRspUserLoginField) {
    this.cThostFtdcRspUserLoginField = cThostFtdcRspUserLoginField;
    return this;
  }

  public void unsetCThostFtdcRspUserLoginField() {
    this.cThostFtdcRspUserLoginField = null;
  }

  /** Returns true if field cThostFtdcRspUserLoginField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcRspUserLoginField() {
    return this.cThostFtdcRspUserLoginField != null;
  }

  public void setCThostFtdcRspUserLoginFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcRspUserLoginField = null;
    }
  }
  ...
  public UserLoginResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public UserLoginResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public UserLoginResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_RSP_USER_LOGIN_FIELD:
      if (value == null) {
        unsetCThostFtdcRspUserLoginField();
      } else {
        setCThostFtdcRspUserLoginField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_RSP_USER_LOGIN_FIELD:
      return getCThostFtdcRspUserLoginField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_RSP_USER_LOGIN_FIELD:
      return isSetCThostFtdcRspUserLoginField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof UserLoginResponse)
      return this.equals((UserLoginResponse)that);
    return false;
  }

  public boolean equals(UserLoginResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcRspUserLoginField = true && this.isSetCThostFtdcRspUserLoginField();
    boolean that_present_cThostFtdcRspUserLoginField = true && that.isSetCThostFtdcRspUserLoginField();
    if (this_present_cThostFtdcRspUserLoginField || that_present_cThostFtdcRspUserLoginField) {
      if (!(this_present_cThostFtdcRspUserLoginField && that_present_cThostFtdcRspUserLoginField))
        return false;
      if (!this.cThostFtdcRspUserLoginField.equals(that.cThostFtdcRspUserLoginField))
        return false;
    }
  ...
  @Override
  public int compareTo(UserLoginResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcRspUserLoginField()).compareTo(other.isSetCThostFtdcRspUserLoginField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcRspUserLoginField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcRspUserLoginField, other.cThostFtdcRspUserLoginField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("UserLoginResponse(");
    boolean first = true;

    sb.append("cThostFtdcRspUserLoginField:");
    if (this.cThostFtdcRspUserLoginField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcRspUserLoginField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcRspUserLoginField != null) {
      cThostFtdcRspUserLoginField.validate();
    }
  ...
  private static class UserLoginResponseStandardSchemeFactory implements SchemeFactory {
    public UserLoginResponseStandardScheme getScheme() {
      return new UserLoginResponseStandardScheme();
    }
  }

  private static class UserLoginResponseStandardScheme extends StandardScheme<UserLoginResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UserLoginResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_RSP_USER_LOGIN_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcRspUserLoginField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspUserLoginField();
              struct.cThostFtdcRspUserLoginField.read(iprot);
              struct.setCThostFtdcRspUserLoginFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserLoginResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcRspUserLoginField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_RSP_USER_LOGIN_FIELD_FIELD_DESC);
        struct.cThostFtdcRspUserLoginField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class UserLoginResponseTupleSchemeFactory implements SchemeFactory {
    public UserLoginResponseTupleScheme getScheme() {
      return new UserLoginResponseTupleScheme();
    }
  }

  private static class UserLoginResponseTupleScheme extends TupleScheme<UserLoginResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UserLoginResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcRspUserLoginField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UserLoginResponse struct) throws org.apache.thrift.TException {
