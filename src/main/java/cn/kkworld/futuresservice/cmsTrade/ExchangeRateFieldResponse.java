...
public class ExchangeRateFieldResponse implements org.apache.thrift.TBase<ExchangeRateFieldResponse, ExchangeRateFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ExchangeRateFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExchangeRateFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_EXCHANGE_RATE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcExchangeRateField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ExchangeRateFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ExchangeRateFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField cThostFtdcExchangeRateField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_EXCHANGE_RATE_FIELD((short)1, "cThostFtdcExchangeRateField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_EXCHANGE_RATE_FIELD
          return C_THOST_FTDC_EXCHANGE_RATE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_EXCHANGE_RATE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcExchangeRateField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExchangeRateFieldResponse.class, metaDataMap);
  }

  public ExchangeRateFieldResponse() {
  }

  public ExchangeRateFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField cThostFtdcExchangeRateField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcExchangeRateField = cThostFtdcExchangeRateField;
   ...
   */
  public ExchangeRateFieldResponse(ExchangeRateFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcExchangeRateField()) {
      this.cThostFtdcExchangeRateField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField(other.cThostFtdcExchangeRateField);
    }
  ...
  public ExchangeRateFieldResponse deepCopy() {
    return new ExchangeRateFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcExchangeRateField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField getCThostFtdcExchangeRateField() {
    return this.cThostFtdcExchangeRateField;
  }

  public ExchangeRateFieldResponse setCThostFtdcExchangeRateField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField cThostFtdcExchangeRateField) {
    this.cThostFtdcExchangeRateField = cThostFtdcExchangeRateField;
    return this;
  }

  public void unsetCThostFtdcExchangeRateField() {
    this.cThostFtdcExchangeRateField = null;
  }

  /** Returns true if field cThostFtdcExchangeRateField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcExchangeRateField() {
    return this.cThostFtdcExchangeRateField != null;
  }

  public void setCThostFtdcExchangeRateFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcExchangeRateField = null;
    }
  }
  ...
  public ExchangeRateFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ExchangeRateFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ExchangeRateFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_EXCHANGE_RATE_FIELD:
      if (value == null) {
        unsetCThostFtdcExchangeRateField();
      } else {
        setCThostFtdcExchangeRateField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_EXCHANGE_RATE_FIELD:
      return getCThostFtdcExchangeRateField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_EXCHANGE_RATE_FIELD:
      return isSetCThostFtdcExchangeRateField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExchangeRateFieldResponse)
      return this.equals((ExchangeRateFieldResponse)that);
    return false;
  }

  public boolean equals(ExchangeRateFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcExchangeRateField = true && this.isSetCThostFtdcExchangeRateField();
    boolean that_present_cThostFtdcExchangeRateField = true && that.isSetCThostFtdcExchangeRateField();
    if (this_present_cThostFtdcExchangeRateField || that_present_cThostFtdcExchangeRateField) {
      if (!(this_present_cThostFtdcExchangeRateField && that_present_cThostFtdcExchangeRateField))
        return false;
      if (!this.cThostFtdcExchangeRateField.equals(that.cThostFtdcExchangeRateField))
        return false;
    }
  ...
  @Override
  public int compareTo(ExchangeRateFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcExchangeRateField()).compareTo(other.isSetCThostFtdcExchangeRateField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcExchangeRateField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcExchangeRateField, other.cThostFtdcExchangeRateField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ExchangeRateFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcExchangeRateField:");
    if (this.cThostFtdcExchangeRateField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcExchangeRateField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcExchangeRateField != null) {
      cThostFtdcExchangeRateField.validate();
    }
  ...
  private static class ExchangeRateFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ExchangeRateFieldResponseStandardScheme getScheme() {
      return new ExchangeRateFieldResponseStandardScheme();
    }
  }

  private static class ExchangeRateFieldResponseStandardScheme extends StandardScheme<ExchangeRateFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ExchangeRateFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_EXCHANGE_RATE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcExchangeRateField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcExchangeRateField();
              struct.cThostFtdcExchangeRateField.read(iprot);
              struct.setCThostFtdcExchangeRateFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExchangeRateFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcExchangeRateField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_EXCHANGE_RATE_FIELD_FIELD_DESC);
        struct.cThostFtdcExchangeRateField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ExchangeRateFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ExchangeRateFieldResponseTupleScheme getScheme() {
      return new ExchangeRateFieldResponseTupleScheme();
    }
  }

  private static class ExchangeRateFieldResponseTupleScheme extends TupleScheme<ExchangeRateFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ExchangeRateFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcExchangeRateField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ExchangeRateFieldResponse struct) throws org.apache.thrift.TException {
