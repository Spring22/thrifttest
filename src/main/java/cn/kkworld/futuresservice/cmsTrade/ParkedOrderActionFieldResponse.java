...
public class ParkedOrderActionFieldResponse implements org.apache.thrift.TBase<ParkedOrderActionFieldResponse, ParkedOrderActionFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ParkedOrderActionFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ParkedOrderActionFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcParkedOrderActionField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ParkedOrderActionFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ParkedOrderActionFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField cThostFtdcParkedOrderActionField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD((short)1, "cThostFtdcParkedOrderActionField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD
          return C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcParkedOrderActionField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ParkedOrderActionFieldResponse.class, metaDataMap);
  }

  public ParkedOrderActionFieldResponse() {
  }

  public ParkedOrderActionFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField cThostFtdcParkedOrderActionField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcParkedOrderActionField = cThostFtdcParkedOrderActionField;
   ...
   */
  public ParkedOrderActionFieldResponse(ParkedOrderActionFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcParkedOrderActionField()) {
      this.cThostFtdcParkedOrderActionField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField(other.cThostFtdcParkedOrderActionField);
    }
  ...
  public ParkedOrderActionFieldResponse deepCopy() {
    return new ParkedOrderActionFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcParkedOrderActionField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField getCThostFtdcParkedOrderActionField() {
    return this.cThostFtdcParkedOrderActionField;
  }

  public ParkedOrderActionFieldResponse setCThostFtdcParkedOrderActionField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField cThostFtdcParkedOrderActionField) {
    this.cThostFtdcParkedOrderActionField = cThostFtdcParkedOrderActionField;
    return this;
  }

  public void unsetCThostFtdcParkedOrderActionField() {
    this.cThostFtdcParkedOrderActionField = null;
  }

  /** Returns true if field cThostFtdcParkedOrderActionField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcParkedOrderActionField() {
    return this.cThostFtdcParkedOrderActionField != null;
  }

  public void setCThostFtdcParkedOrderActionFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcParkedOrderActionField = null;
    }
  }
  ...
  public ParkedOrderActionFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ParkedOrderActionFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ParkedOrderActionFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD:
      if (value == null) {
        unsetCThostFtdcParkedOrderActionField();
      } else {
        setCThostFtdcParkedOrderActionField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD:
      return getCThostFtdcParkedOrderActionField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD:
      return isSetCThostFtdcParkedOrderActionField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ParkedOrderActionFieldResponse)
      return this.equals((ParkedOrderActionFieldResponse)that);
    return false;
  }

  public boolean equals(ParkedOrderActionFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcParkedOrderActionField = true && this.isSetCThostFtdcParkedOrderActionField();
    boolean that_present_cThostFtdcParkedOrderActionField = true && that.isSetCThostFtdcParkedOrderActionField();
    if (this_present_cThostFtdcParkedOrderActionField || that_present_cThostFtdcParkedOrderActionField) {
      if (!(this_present_cThostFtdcParkedOrderActionField && that_present_cThostFtdcParkedOrderActionField))
        return false;
      if (!this.cThostFtdcParkedOrderActionField.equals(that.cThostFtdcParkedOrderActionField))
        return false;
    }
  ...
  @Override
  public int compareTo(ParkedOrderActionFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcParkedOrderActionField()).compareTo(other.isSetCThostFtdcParkedOrderActionField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcParkedOrderActionField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcParkedOrderActionField, other.cThostFtdcParkedOrderActionField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ParkedOrderActionFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcParkedOrderActionField:");
    if (this.cThostFtdcParkedOrderActionField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcParkedOrderActionField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcParkedOrderActionField != null) {
      cThostFtdcParkedOrderActionField.validate();
    }
  ...
  private static class ParkedOrderActionFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ParkedOrderActionFieldResponseStandardScheme getScheme() {
      return new ParkedOrderActionFieldResponseStandardScheme();
    }
  }

  private static class ParkedOrderActionFieldResponseStandardScheme extends StandardScheme<ParkedOrderActionFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ParkedOrderActionFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcParkedOrderActionField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcParkedOrderActionField();
              struct.cThostFtdcParkedOrderActionField.read(iprot);
              struct.setCThostFtdcParkedOrderActionFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ParkedOrderActionFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcParkedOrderActionField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_PARKED_ORDER_ACTION_FIELD_FIELD_DESC);
        struct.cThostFtdcParkedOrderActionField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ParkedOrderActionFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ParkedOrderActionFieldResponseTupleScheme getScheme() {
      return new ParkedOrderActionFieldResponseTupleScheme();
    }
  }

  private static class ParkedOrderActionFieldResponseTupleScheme extends TupleScheme<ParkedOrderActionFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ParkedOrderActionFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcParkedOrderActionField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ParkedOrderActionFieldResponse struct) throws org.apache.thrift.TException {
