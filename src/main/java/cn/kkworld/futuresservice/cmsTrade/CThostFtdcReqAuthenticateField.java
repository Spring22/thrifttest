...
public class CThostFtdcReqAuthenticateField implements org.apache.thrift.TBase<CThostFtdcReqAuthenticateField, CThostFtdcReqAuthenticateField._Fields>, java.io.Serializable, Cloneable, Comparable<CThostFtdcReqAuthenticateField> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CThostFtdcReqAuthenticateField");
  ...
  static {
    schemes.put(StandardScheme.class, new CThostFtdcReqAuthenticateFieldStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CThostFtdcReqAuthenticateFieldTupleSchemeFactory());
  }
  ...
  static {
    ...
    tmpMap.put(_Fields.AUTH_CODE, new org.apache.thrift.meta_data.FieldMetaData("authCode", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "TThostFtdcAuthCodeType")));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CThostFtdcReqAuthenticateField.class, metaDataMap);
  }
   ...
   */
  public CThostFtdcReqAuthenticateField(CThostFtdcReqAuthenticateField other) {
  ...
  public CThostFtdcReqAuthenticateField deepCopy() {
    return new CThostFtdcReqAuthenticateField(this);
  }
  ...
  public CThostFtdcReqAuthenticateField setBrokerID(String brokerID) {
    this.brokerID = brokerID;
    return this;
  }
  ...
  public CThostFtdcReqAuthenticateField setUserID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  public CThostFtdcReqAuthenticateField setUserProductInfo(String userProductInfo) {
    this.userProductInfo = userProductInfo;
    return this;
  }
  ...
  public CThostFtdcReqAuthenticateField setAuthCode(String authCode) {
    this.authCode = authCode;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CThostFtdcReqAuthenticateField)
      return this.equals((CThostFtdcReqAuthenticateField)that);
    return false;
  }

  public boolean equals(CThostFtdcReqAuthenticateField that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CThostFtdcReqAuthenticateField other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CThostFtdcReqAuthenticateField(");
    boolean first = true;
  ...
  private static class CThostFtdcReqAuthenticateFieldStandardSchemeFactory implements SchemeFactory {
    public CThostFtdcReqAuthenticateFieldStandardScheme getScheme() {
      return new CThostFtdcReqAuthenticateFieldStandardScheme();
    }
  }

  private static class CThostFtdcReqAuthenticateFieldStandardScheme extends StandardScheme<CThostFtdcReqAuthenticateField> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CThostFtdcReqAuthenticateField struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CThostFtdcReqAuthenticateField struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CThostFtdcReqAuthenticateFieldTupleSchemeFactory implements SchemeFactory {
    public CThostFtdcReqAuthenticateFieldTupleScheme getScheme() {
      return new CThostFtdcReqAuthenticateFieldTupleScheme();
    }
  }

  private static class CThostFtdcReqAuthenticateFieldTupleScheme extends TupleScheme<CThostFtdcReqAuthenticateField> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CThostFtdcReqAuthenticateField struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CThostFtdcReqAuthenticateField struct) throws org.apache.thrift.TException {
