...
public class CThostFtdcOrderActionField implements org.apache.thrift.TBase<CThostFtdcOrderActionField, CThostFtdcOrderActionField._Fields>, java.io.Serializable, Cloneable, Comparable<CThostFtdcOrderActionField> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CThostFtdcOrderActionField");
  ...
  private static final org.apache.thrift.protocol.TField DTATUS_MSG_FIELD_DESC = new org.apache.thrift.protocol.TField("dtatusMsg", org.apache.thrift.protocol.TType.STRING, (short)24);
  ...
  static {
    schemes.put(StandardScheme.class, new CThostFtdcOrderActionFieldStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CThostFtdcOrderActionFieldTupleSchemeFactory());
  }
  ...
  public String dtatusMsg; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.DTATUS_MSG, new org.apache.thrift.meta_data.FieldMetaData("dtatusMsg", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CThostFtdcOrderActionField.class, metaDataMap);
  }
   ...
   */
  public CThostFtdcOrderActionField(CThostFtdcOrderActionField other) {
    ...
    if (other.isSetDtatusMsg()) {
      this.dtatusMsg = other.dtatusMsg;
    }
  ...
  public CThostFtdcOrderActionField deepCopy() {
    return new CThostFtdcOrderActionField(this);
  }
  ...
  public CThostFtdcOrderActionField setBrokerID(String brokerID) {
    this.brokerID = brokerID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setInvestorID(String investorID) {
    this.investorID = investorID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setOrderActionRef(int orderActionRef) {
    this.orderActionRef = orderActionRef;
    setOrderActionRefIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setOrderRef(String orderRef) {
    this.orderRef = orderRef;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setRequestID(int requestID) {
    this.requestID = requestID;
    setRequestIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setFrontID(int frontID) {
    this.frontID = frontID;
    setFrontIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setSessionID(int sessionID) {
    this.sessionID = sessionID;
    setSessionIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setExchangeID(String exchangeID) {
    this.exchangeID = exchangeID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setOrderSysID(String orderSysID) {
    this.orderSysID = orderSysID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setActionFlag(String actionFlag) {
    this.actionFlag = actionFlag;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setLimitPrice(double limitPrice) {
    this.limitPrice = limitPrice;
    setLimitPriceIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setVolumeChange(int volumeChange) {
    this.volumeChange = volumeChange;
    setVolumeChangeIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setActionDate(String actionDate) {
    this.actionDate = actionDate;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setActionTime(String actionTime) {
    this.actionTime = actionTime;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setTraderID(String traderID) {
    this.traderID = traderID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setInstallID(int installID) {
    this.installID = installID;
    setInstallIDIsSet(true);
    return this;
  }
  ...
  public CThostFtdcOrderActionField setOrderLocalID(String orderLocalID) {
    this.orderLocalID = orderLocalID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setActionLocalID(String actionLocalID) {
    this.actionLocalID = actionLocalID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setParticipantID(String participantID) {
    this.participantID = participantID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setClientID(String clientID) {
    this.clientID = clientID;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setBusinessUnit(String businessUnit) {
    this.businessUnit = businessUnit;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setOrderActionStatus(String orderActionStatus) {
    this.orderActionStatus = orderActionStatus;
    return this;
  }
  ...
  public CThostFtdcOrderActionField setUserID(String userID) {
    this.userID = userID;
    return this;
  }
  ...
  public String getDtatusMsg() {
    return this.dtatusMsg;
  }

  public CThostFtdcOrderActionField setDtatusMsg(String dtatusMsg) {
    this.dtatusMsg = dtatusMsg;
    return this;
  }

  public void unsetDtatusMsg() {
    this.dtatusMsg = null;
  }

  /** Returns true if field dtatusMsg is set (has been assigned a value) and false otherwise */
  public boolean isSetDtatusMsg() {
    return this.dtatusMsg != null;
  }

  public void setDtatusMsgIsSet(boolean value) {
    if (!value) {
      this.dtatusMsg = null;
    }
  }
  ...
  public CThostFtdcOrderActionField setInstrumentID(String instrumentID) {
    this.instrumentID = instrumentID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CThostFtdcOrderActionField)
      return this.equals((CThostFtdcOrderActionField)that);
    return false;
  }

  public boolean equals(CThostFtdcOrderActionField that) {
    if (that == null)
      return false;
    ...
    boolean this_present_dtatusMsg = true && this.isSetDtatusMsg();
    boolean that_present_dtatusMsg = true && that.isSetDtatusMsg();
    if (this_present_dtatusMsg || that_present_dtatusMsg) {
      if (!(this_present_dtatusMsg && that_present_dtatusMsg))
        return false;
      if (!this.dtatusMsg.equals(that.dtatusMsg))
        return false;
    }
  ...
  @Override
  public int compareTo(CThostFtdcOrderActionField other) {
    ...
    lastComparison = Boolean.valueOf(isSetDtatusMsg()).compareTo(other.isSetDtatusMsg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDtatusMsg()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dtatusMsg, other.dtatusMsg);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CThostFtdcOrderActionField(");
    boolean first = true;
    ...
    if (!first) sb.append(", ");
    sb.append("dtatusMsg:");
    if (this.dtatusMsg == null) {
      sb.append("null");
    } else {
      sb.append(this.dtatusMsg);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class CThostFtdcOrderActionFieldStandardSchemeFactory implements SchemeFactory {
    public CThostFtdcOrderActionFieldStandardScheme getScheme() {
      return new CThostFtdcOrderActionFieldStandardScheme();
    }
  }

  private static class CThostFtdcOrderActionFieldStandardScheme extends StandardScheme<CThostFtdcOrderActionField> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CThostFtdcOrderActionField struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 24: // DTATUS_MSG
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.dtatusMsg = iprot.readString();
              struct.setDtatusMsgIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CThostFtdcOrderActionField struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.dtatusMsg != null) {
        oprot.writeFieldBegin(DTATUS_MSG_FIELD_DESC);
        oprot.writeString(struct.dtatusMsg);
        oprot.writeFieldEnd();
      }
  ...
  private static class CThostFtdcOrderActionFieldTupleSchemeFactory implements SchemeFactory {
    public CThostFtdcOrderActionFieldTupleScheme getScheme() {
      return new CThostFtdcOrderActionFieldTupleScheme();
    }
  }

  private static class CThostFtdcOrderActionFieldTupleScheme extends TupleScheme<CThostFtdcOrderActionField> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CThostFtdcOrderActionField struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CThostFtdcOrderActionField struct) throws org.apache.thrift.TException {
