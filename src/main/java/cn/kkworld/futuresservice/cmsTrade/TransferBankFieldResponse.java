...
public class TransferBankFieldResponse implements org.apache.thrift.TBase<TransferBankFieldResponse, TransferBankFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TransferBankFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TransferBankFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_TRANSFER_BANK_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcTransferBankField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new TransferBankFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TransferBankFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField cThostFtdcTransferBankField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_TRANSFER_BANK_FIELD((short)1, "cThostFtdcTransferBankField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_TRANSFER_BANK_FIELD
          return C_THOST_FTDC_TRANSFER_BANK_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_TRANSFER_BANK_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcTransferBankField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TransferBankFieldResponse.class, metaDataMap);
  }

  public TransferBankFieldResponse() {
  }

  public TransferBankFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField cThostFtdcTransferBankField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcTransferBankField = cThostFtdcTransferBankField;
   ...
   */
  public TransferBankFieldResponse(TransferBankFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcTransferBankField()) {
      this.cThostFtdcTransferBankField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField(other.cThostFtdcTransferBankField);
    }
  ...
  public TransferBankFieldResponse deepCopy() {
    return new TransferBankFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcTransferBankField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField getCThostFtdcTransferBankField() {
    return this.cThostFtdcTransferBankField;
  }

  public TransferBankFieldResponse setCThostFtdcTransferBankField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField cThostFtdcTransferBankField) {
    this.cThostFtdcTransferBankField = cThostFtdcTransferBankField;
    return this;
  }

  public void unsetCThostFtdcTransferBankField() {
    this.cThostFtdcTransferBankField = null;
  }

  /** Returns true if field cThostFtdcTransferBankField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcTransferBankField() {
    return this.cThostFtdcTransferBankField != null;
  }

  public void setCThostFtdcTransferBankFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcTransferBankField = null;
    }
  }
  ...
  public TransferBankFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public TransferBankFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public TransferBankFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_TRANSFER_BANK_FIELD:
      if (value == null) {
        unsetCThostFtdcTransferBankField();
      } else {
        setCThostFtdcTransferBankField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_TRANSFER_BANK_FIELD:
      return getCThostFtdcTransferBankField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_TRANSFER_BANK_FIELD:
      return isSetCThostFtdcTransferBankField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TransferBankFieldResponse)
      return this.equals((TransferBankFieldResponse)that);
    return false;
  }

  public boolean equals(TransferBankFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcTransferBankField = true && this.isSetCThostFtdcTransferBankField();
    boolean that_present_cThostFtdcTransferBankField = true && that.isSetCThostFtdcTransferBankField();
    if (this_present_cThostFtdcTransferBankField || that_present_cThostFtdcTransferBankField) {
      if (!(this_present_cThostFtdcTransferBankField && that_present_cThostFtdcTransferBankField))
        return false;
      if (!this.cThostFtdcTransferBankField.equals(that.cThostFtdcTransferBankField))
        return false;
    }
  ...
  @Override
  public int compareTo(TransferBankFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcTransferBankField()).compareTo(other.isSetCThostFtdcTransferBankField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcTransferBankField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcTransferBankField, other.cThostFtdcTransferBankField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TransferBankFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcTransferBankField:");
    if (this.cThostFtdcTransferBankField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcTransferBankField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcTransferBankField != null) {
      cThostFtdcTransferBankField.validate();
    }
  ...
  private static class TransferBankFieldResponseStandardSchemeFactory implements SchemeFactory {
    public TransferBankFieldResponseStandardScheme getScheme() {
      return new TransferBankFieldResponseStandardScheme();
    }
  }

  private static class TransferBankFieldResponseStandardScheme extends StandardScheme<TransferBankFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TransferBankFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_TRANSFER_BANK_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcTransferBankField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTransferBankField();
              struct.cThostFtdcTransferBankField.read(iprot);
              struct.setCThostFtdcTransferBankFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TransferBankFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcTransferBankField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_TRANSFER_BANK_FIELD_FIELD_DESC);
        struct.cThostFtdcTransferBankField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class TransferBankFieldResponseTupleSchemeFactory implements SchemeFactory {
    public TransferBankFieldResponseTupleScheme getScheme() {
      return new TransferBankFieldResponseTupleScheme();
    }
  }

  private static class TransferBankFieldResponseTupleScheme extends TupleScheme<TransferBankFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TransferBankFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcTransferBankField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TransferBankFieldResponse struct) throws org.apache.thrift.TException {
