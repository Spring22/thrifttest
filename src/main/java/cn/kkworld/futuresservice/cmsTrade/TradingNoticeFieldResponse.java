...
public class TradingNoticeFieldResponse implements org.apache.thrift.TBase<TradingNoticeFieldResponse, TradingNoticeFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TradingNoticeFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TradingNoticeFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_TRADING_NOTICE_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcTradingNoticeField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new TradingNoticeFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TradingNoticeFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField cThostFtdcTradingNoticeField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_TRADING_NOTICE_FIELD((short)1, "cThostFtdcTradingNoticeField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_TRADING_NOTICE_FIELD
          return C_THOST_FTDC_TRADING_NOTICE_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_TRADING_NOTICE_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcTradingNoticeField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TradingNoticeFieldResponse.class, metaDataMap);
  }

  public TradingNoticeFieldResponse() {
  }

  public TradingNoticeFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField cThostFtdcTradingNoticeField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcTradingNoticeField = cThostFtdcTradingNoticeField;
   ...
   */
  public TradingNoticeFieldResponse(TradingNoticeFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcTradingNoticeField()) {
      this.cThostFtdcTradingNoticeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField(other.cThostFtdcTradingNoticeField);
    }
  ...
  public TradingNoticeFieldResponse deepCopy() {
    return new TradingNoticeFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcTradingNoticeField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField getCThostFtdcTradingNoticeField() {
    return this.cThostFtdcTradingNoticeField;
  }

  public TradingNoticeFieldResponse setCThostFtdcTradingNoticeField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField cThostFtdcTradingNoticeField) {
    this.cThostFtdcTradingNoticeField = cThostFtdcTradingNoticeField;
    return this;
  }

  public void unsetCThostFtdcTradingNoticeField() {
    this.cThostFtdcTradingNoticeField = null;
  }

  /** Returns true if field cThostFtdcTradingNoticeField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcTradingNoticeField() {
    return this.cThostFtdcTradingNoticeField != null;
  }

  public void setCThostFtdcTradingNoticeFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcTradingNoticeField = null;
    }
  }
  ...
  public TradingNoticeFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public TradingNoticeFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public TradingNoticeFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_TRADING_NOTICE_FIELD:
      if (value == null) {
        unsetCThostFtdcTradingNoticeField();
      } else {
        setCThostFtdcTradingNoticeField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_TRADING_NOTICE_FIELD:
      return getCThostFtdcTradingNoticeField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_TRADING_NOTICE_FIELD:
      return isSetCThostFtdcTradingNoticeField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TradingNoticeFieldResponse)
      return this.equals((TradingNoticeFieldResponse)that);
    return false;
  }

  public boolean equals(TradingNoticeFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcTradingNoticeField = true && this.isSetCThostFtdcTradingNoticeField();
    boolean that_present_cThostFtdcTradingNoticeField = true && that.isSetCThostFtdcTradingNoticeField();
    if (this_present_cThostFtdcTradingNoticeField || that_present_cThostFtdcTradingNoticeField) {
      if (!(this_present_cThostFtdcTradingNoticeField && that_present_cThostFtdcTradingNoticeField))
        return false;
      if (!this.cThostFtdcTradingNoticeField.equals(that.cThostFtdcTradingNoticeField))
        return false;
    }
  ...
  @Override
  public int compareTo(TradingNoticeFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcTradingNoticeField()).compareTo(other.isSetCThostFtdcTradingNoticeField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcTradingNoticeField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcTradingNoticeField, other.cThostFtdcTradingNoticeField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TradingNoticeFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcTradingNoticeField:");
    if (this.cThostFtdcTradingNoticeField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcTradingNoticeField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcTradingNoticeField != null) {
      cThostFtdcTradingNoticeField.validate();
    }
  ...
  private static class TradingNoticeFieldResponseStandardSchemeFactory implements SchemeFactory {
    public TradingNoticeFieldResponseStandardScheme getScheme() {
      return new TradingNoticeFieldResponseStandardScheme();
    }
  }

  private static class TradingNoticeFieldResponseStandardScheme extends StandardScheme<TradingNoticeFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TradingNoticeFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_TRADING_NOTICE_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcTradingNoticeField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcTradingNoticeField();
              struct.cThostFtdcTradingNoticeField.read(iprot);
              struct.setCThostFtdcTradingNoticeFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TradingNoticeFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcTradingNoticeField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_TRADING_NOTICE_FIELD_FIELD_DESC);
        struct.cThostFtdcTradingNoticeField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class TradingNoticeFieldResponseTupleSchemeFactory implements SchemeFactory {
    public TradingNoticeFieldResponseTupleScheme getScheme() {
      return new TradingNoticeFieldResponseTupleScheme();
    }
  }

  private static class TradingNoticeFieldResponseTupleScheme extends TupleScheme<TradingNoticeFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TradingNoticeFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcTradingNoticeField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TradingNoticeFieldResponse struct) throws org.apache.thrift.TException {
