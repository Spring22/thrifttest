...
public class ContractBankFieldResponse implements org.apache.thrift.TBase<ContractBankFieldResponse, ContractBankFieldResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ContractBankFieldResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ContractBankFieldResponse");

  private static final org.apache.thrift.protocol.TField C_THOST_FTDC_CONTRACT_BANK_FIELD_FIELD_DESC = new org.apache.thrift.protocol.TField("cThostFtdcContractBankField", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new ContractBankFieldResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ContractBankFieldResponseTupleSchemeFactory());
  }

  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField cThostFtdcContractBankField; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    C_THOST_FTDC_CONTRACT_BANK_FIELD((short)1, "cThostFtdcContractBankField"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // C_THOST_FTDC_CONTRACT_BANK_FIELD
          return C_THOST_FTDC_CONTRACT_BANK_FIELD;
  ...
  static {
    ...
    tmpMap.put(_Fields.C_THOST_FTDC_CONTRACT_BANK_FIELD, new org.apache.thrift.meta_data.FieldMetaData("cThostFtdcContractBankField", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ContractBankFieldResponse.class, metaDataMap);
  }

  public ContractBankFieldResponse() {
  }

  public ContractBankFieldResponse(
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField cThostFtdcContractBankField,
    cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField,
    int nRequestID,
    boolean bIsLast)
  {
    this();
    this.cThostFtdcContractBankField = cThostFtdcContractBankField;
   ...
   */
  public ContractBankFieldResponse(ContractBankFieldResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetCThostFtdcContractBankField()) {
      this.cThostFtdcContractBankField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField(other.cThostFtdcContractBankField);
    }
  ...
  public ContractBankFieldResponse deepCopy() {
    return new ContractBankFieldResponse(this);
  }

  @Override
  public void clear() {
    this.cThostFtdcContractBankField = null;
  ...
  public cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField getCThostFtdcContractBankField() {
    return this.cThostFtdcContractBankField;
  }

  public ContractBankFieldResponse setCThostFtdcContractBankField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField cThostFtdcContractBankField) {
    this.cThostFtdcContractBankField = cThostFtdcContractBankField;
    return this;
  }

  public void unsetCThostFtdcContractBankField() {
    this.cThostFtdcContractBankField = null;
  }

  /** Returns true if field cThostFtdcContractBankField is set (has been assigned a value) and false otherwise */
  public boolean isSetCThostFtdcContractBankField() {
    return this.cThostFtdcContractBankField != null;
  }

  public void setCThostFtdcContractBankFieldIsSet(boolean value) {
    if (!value) {
      this.cThostFtdcContractBankField = null;
    }
  }
  ...
  public ContractBankFieldResponse setCThostFtdcRspInfoField(cn.kkworld.futuresservice.cmsTrade.CThostFtdcRspInfoField cThostFtdcRspInfoField) {
    this.cThostFtdcRspInfoField = cThostFtdcRspInfoField;
    return this;
  }
  ...
  public ContractBankFieldResponse setNRequestID(int nRequestID) {
    this.nRequestID = nRequestID;
    setNRequestIDIsSet(true);
    return this;
  }
  ...
  public ContractBankFieldResponse setBIsLast(boolean bIsLast) {
    this.bIsLast = bIsLast;
    setBIsLastIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case C_THOST_FTDC_CONTRACT_BANK_FIELD:
      if (value == null) {
        unsetCThostFtdcContractBankField();
      } else {
        setCThostFtdcContractBankField((cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case C_THOST_FTDC_CONTRACT_BANK_FIELD:
      return getCThostFtdcContractBankField();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case C_THOST_FTDC_CONTRACT_BANK_FIELD:
      return isSetCThostFtdcContractBankField();
    case C_THOST_FTDC_RSP_INFO_FIELD:
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ContractBankFieldResponse)
      return this.equals((ContractBankFieldResponse)that);
    return false;
  }

  public boolean equals(ContractBankFieldResponse that) {
    if (that == null)
      return false;

    boolean this_present_cThostFtdcContractBankField = true && this.isSetCThostFtdcContractBankField();
    boolean that_present_cThostFtdcContractBankField = true && that.isSetCThostFtdcContractBankField();
    if (this_present_cThostFtdcContractBankField || that_present_cThostFtdcContractBankField) {
      if (!(this_present_cThostFtdcContractBankField && that_present_cThostFtdcContractBankField))
        return false;
      if (!this.cThostFtdcContractBankField.equals(that.cThostFtdcContractBankField))
        return false;
    }
  ...
  @Override
  public int compareTo(ContractBankFieldResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetCThostFtdcContractBankField()).compareTo(other.isSetCThostFtdcContractBankField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCThostFtdcContractBankField()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cThostFtdcContractBankField, other.cThostFtdcContractBankField);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ContractBankFieldResponse(");
    boolean first = true;

    sb.append("cThostFtdcContractBankField:");
    if (this.cThostFtdcContractBankField == null) {
      sb.append("null");
    } else {
      sb.append(this.cThostFtdcContractBankField);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (cThostFtdcContractBankField != null) {
      cThostFtdcContractBankField.validate();
    }
  ...
  private static class ContractBankFieldResponseStandardSchemeFactory implements SchemeFactory {
    public ContractBankFieldResponseStandardScheme getScheme() {
      return new ContractBankFieldResponseStandardScheme();
    }
  }

  private static class ContractBankFieldResponseStandardScheme extends StandardScheme<ContractBankFieldResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ContractBankFieldResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // C_THOST_FTDC_CONTRACT_BANK_FIELD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.cThostFtdcContractBankField = new cn.kkworld.futuresservice.cmsTrade.CThostFtdcContractBankField();
              struct.cThostFtdcContractBankField.read(iprot);
              struct.setCThostFtdcContractBankFieldIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ContractBankFieldResponse struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.cThostFtdcContractBankField != null) {
        oprot.writeFieldBegin(C_THOST_FTDC_CONTRACT_BANK_FIELD_FIELD_DESC);
        struct.cThostFtdcContractBankField.write(oprot);
        oprot.writeFieldEnd();
      }
  ...
  private static class ContractBankFieldResponseTupleSchemeFactory implements SchemeFactory {
    public ContractBankFieldResponseTupleScheme getScheme() {
      return new ContractBankFieldResponseTupleScheme();
    }
  }

  private static class ContractBankFieldResponseTupleScheme extends TupleScheme<ContractBankFieldResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ContractBankFieldResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetCThostFtdcContractBankField()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ContractBankFieldResponse struct) throws org.apache.thrift.TException {
