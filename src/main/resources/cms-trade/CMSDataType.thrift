...
typedef string TThostFtdcTraderIDType
///TFtdcInvestorIDType是一个投资者代码类型
typedef string TThostFtdcInvestorIDType
///TFtdcBrokerIDType是一个经纪公司代码类型
typedef string TThostFtdcBrokerIDType
///TFtdcBrokerAbbrType是一个经纪公司简称类型
typedef string TThostFtdcBrokerAbbrType
///TFtdcBrokerNameType是一个经纪公司名称类型
typedef string TThostFtdcBrokerNameType
///TFtdcExchangeInstIDType是一个合约在交易所的代码类型
typedef string TThostFtdcExchangeInstIDType
///TFtdcOrderRefType是一个报单引用类型
typedef string TThostFtdcOrderRefType
///TFtdcParticipantIDType是一个会员代码类型
typedef string TThostFtdcParticipantIDType
///TFtdcUserIDType是一个用户代码类型
typedef string TThostFtdcUserIDType
///TFtdcPasswordType是一个密码类型
typedef string TThostFtdcPasswordType
///TFtdcClientIDType是一个交易编码类型
typedef string TThostFtdcClientIDType
///TFtdcInstrumentIDType是一个合约代码类型
typedef string TThostFtdcInstrumentIDType
///TFtdcMarketIDType是一个市场代码类型
typedef string TThostFtdcMarketIDType
///TFtdcProductNameType是一个产品名称类型
typedef string TThostFtdcProductNameType
///TFtdcExchangeIDType是一个交易所代码类型
typedef string TThostFtdcExchangeIDType
///TFtdcExchangeNameType是一个交易所名称类型
typedef string TThostFtdcExchangeNameType
///TFtdcExchangeAbbrType是一个交易所简称类型
typedef string TThostFtdcExchangeAbbrType
///TFtdcExchangeFlagType是一个交易所标志类型
typedef string TThostFtdcExchangeFlagType
///TFtdcMacAddressType是一个Mac地址类型
typedef string TThostFtdcMacAddressType
///TFtdcSystemIDType是一个系统编号类型
typedef string TThostFtdcSystemIDType
typedef string TThostFtdcExchangePropertyType
///TFtdcDateType是一个日期类型
typedef string TThostFtdcDateType
///TFtdcTimeType是一个时间类型
typedef string TThostFtdcTimeType
///TFtdcLongTimeType是一个长时间类型
typedef string TThostFtdcLongTimeType
///TFtdcInstrumentNameType是一个合约名称类型
typedef string TThostFtdcInstrumentNameType
///TFtdcSettlementGroupIDType是一个结算组代码类型
typedef string TThostFtdcSettlementGroupIDType
///TFtdcOrderSysIDType是一个报单编号类型
typedef string TThostFtdcOrderSysIDType
///TFtdcTradeIDType是一个成交编号类型
typedef string TThostFtdcTradeIDType
///TFtdcCommandTypeType是一个DB命令类型类型
typedef string TThostFtdcCommandTypeType
///TFtdcIPAddressType是一个IP地址类型
typedef string TThostFtdcIPAddressType
///TFtdcIPPortType是一个IP端口类型
typedef i32 TThostFtdcIPPortType
///TFtdcProductInfoType是一个产品信息类型
typedef string TThostFtdcProductInfoType
///TFtdcProtocolInfoType是一个协议信息类型
typedef string TThostFtdcProtocolInfoType
///TFtdcBusinessUnitType是一个业务单元类型
typedef string TThostFtdcBusinessUnitType
///TFtdcDepositSeqNoType是一个出入金流水号类型
typedef string TThostFtdcDepositSeqNoType
///TFtdcIdentifiedCardNoType是一个证件号码类型
typedef string TThostFtdcIdentifiedCardNoType
typedef string TThostFtdcIdCardTypeType
///TFtdcOrderLocalIDType是一个本地报单编号类型
typedef string TThostFtdcOrderLocalIDType
///TFtdcUserNameType是一个用户名称类型
typedef string TThostFtdcUserNameType
///TFtdcPartyNameType是一个参与人名称类型
typedef string TThostFtdcPartyNameType
///TFtdcErrorMsgType是一个错误信息类型
typedef string TThostFtdcErrorMsgType
///TFtdcFieldNameType是一个字段名类型
typedef string TThostFtdcFieldNameType
///TFtdcFieldContentType是一个字段内容类型
typedef string TThostFtdcFieldContentType
///TFtdcSystemNameType是一个系统名称类型
typedef string TThostFtdcSystemNameType
///TFtdcContentType是一个消息正文类型
typedef string TThostFtdcContentType
...
typedef string TThostFtdcInvestorRangeType
...
typedef string TThostFtdcDepartmentRangeType
typedef string TThostFtdcDataSyncStatusType
///TFtdcBrokerDataSyncStatusType是一个经纪公司数据同步状态类型
///已同步
//// THOST_FTDC_BDS_Synchronized '1'
///同步中
//// THOST_FTDC_BDS_Synchronizing '2'
typedef string TThostFtdcBrokerDataSyncStatusType
...
typedef string TThostFtdcExchangeConnectStatusType
...
typedef string TThostFtdcTraderConnectStatusType
...
typedef string TThostFtdcFunctionCodeType
...
typedef string TThostFtdcBrokerFunctionCodeType
...
typedef string TThostFtdcOrderActionStatusType
...
typedef string TThostFtdcOrderStatusType
...
typedef string TThostFtdcTradingRoleType
...
typedef string TThostFtdcProductClassType
...
typedef string TThostFtdcInstLifePhaseType
///TFtdcDirectionType是一个买卖方向类型
///买
//// THOST_FTDC_D_Buy '0'
///卖
//// THOST_FTDC_D_Sell '1'
typedef string TThostFtdcDirectionType
///TFtdcPositionTypeType是一个持仓类型类型
///净持仓
//// THOST_FTDC_PT_Net '1'
///综合持仓
//// THOST_FTDC_PT_Gross '2'
typedef string TThostFtdcPositionTypeType
...
typedef string TThostFtdcPosiDirectionType
...
typedef string TThostFtdcSysSettlementStatusType
///TFtdcRatioAttrType是一个费率属性类型
///交易费率
//// THOST_FTDC_RA_Trade '0'
///结算费率
//// THOST_FTDC_RA_Settlement '1'
typedef string TThostFtdcRatioAttrType
...
typedef string TThostFtdcHedgeFlagType
...
typedef string TThostFtdcBillHedgeFlagType
...
typedef string TThostFtdcClientIDTypeType
...
typedef string TThostFtdcOrderPriceTypeType
...
typedef string TThostFtdcOffsetFlagType
...
typedef string TThostFtdcForceCloseReasonType
...
typedef string TThostFtdcOrderTypeType
...
///集合竞价有效
//// THOST_FTDC_TC_GFA '6'
typedef string TThostFtdcTimeConditionType
...
///全部数量
//// THOST_FTDC_VC_CV '3'
typedef string TThostFtdcVolumeConditionType
...
typedef string TThostFtdcContingentConditionType
///TFtdcActionFlagType是一个操作标志类型
///删除
//// THOST_FTDC_AF_Delete '0'
///修改
//// THOST_FTDC_AF_Modify '3'
typedef string TThostFtdcActionFlagType
...
typedef string TThostFtdcTradingRightType
///TFtdcOrderSourceType是一个报单来源类型
///来自参与者
//// THOST_FTDC_OSRC_Participant '0'
///来自管理员
//// THOST_FTDC_OSRC_Administrator '1'
typedef string TThostFtdcOrderSourceType
...
typedef string TThostFtdcTradeTypeType
...
typedef string TThostFtdcPriceSourceType
...
typedef string TThostFtdcInstrumentStatusType
...
typedef string TThostFtdcInstStatusEnterReasonType
///TFtdcOrderActionRefType是一个报单操作引用类型
typedef i32 TThostFtdcOrderActionRefType
///TFtdcInstallCountType是一个安装数量类型
typedef i32 TThostFtdcInstallCountType
///TFtdcInstallIDType是一个安装编号类型
typedef i32 TThostFtdcInstallIDType
///TFtdcErrorIDType是一个错误代码类型
typedef i32 TThostFtdcErrorIDType
///TFtdcSettlementIDType是一个结算编号类型
typedef i32 TThostFtdcSettlementIDType
///TFtdcVolumeType是一个数量类型
typedef i32 TThostFtdcVolumeType
///TFtdcFrontIDType是一个前置编号类型
typedef i32 TThostFtdcFrontIDType
///TFtdcSessionIDType是一个会话编号类型
typedef i32 TThostFtdcSessionIDType
///TFtdcSequenceNoType是一个序号类型
typedef i32 TThostFtdcSequenceNoType
///TFtdcCommandNoType是一个DB命令序号类型
typedef i32 TThostFtdcCommandNoType
///TFtdcMillisecType是一个时间（毫秒）类型
typedef i32 TThostFtdcMillisecType
///TFtdcVolumeMultipleType是一个合约数量乘数类型
typedef i32 TThostFtdcVolumeMultipleType
///TFtdcTradingSegmentSNType是一个交易阶段编号类型
typedef i32 TThostFtdcTradingSegmentSNType
///TFtdcRequestIDType是一个请求编号类型
typedef i32 TThostFtdcRequestIDType
///TFtdcYearType是一个年份类型
typedef i32 TThostFtdcYearType
///TFtdcMonthType是一个月份类型
typedef i32 TThostFtdcMonthType
///TFtdcBoolType是一个布尔型类型
typedef i32 TThostFtdcBoolType
///TFtdcPriceType是一个价格类型
typedef double TThostFtdcPriceType
///TFtdcCombOffsetFlagType是一个组合开平标志类型
typedef string TThostFtdcCombOffsetFlagType
///TFtdcCombHedgeFlagType是一个组合投机套保标志类型
typedef string TThostFtdcCombHedgeFlagType
...
typedef i16 TThostFtdcSequenceSeriesType
///TFtdcCommPhaseNoType是一个通讯时段编号类型
typedef i16 TThostFtdcCommPhaseNoType
///TFtdcSequenceLabelType是一个序列编号类型
typedef string TThostFtdcSequenceLabelType
///TFtdcUnderlyingMultipleType是一个基础商品乘数类型
typedef double TThostFtdcUnderlyingMultipleType
///TFtdcPriorityType是一个优先级类型
typedef i32 TThostFtdcPriorityType
///TFtdcContractCodeType是一个合同编号类型
typedef string TThostFtdcContractCodeType
///TFtdcCityType是一个市类型
typedef string TThostFtdcCityType
///TFtdcIsStockType是一个是否股民类型
typedef string TThostFtdcIsStockType
///TFtdcChannelType是一个渠道类型
typedef string TThostFtdcChannelType
///TFtdcAddressType是一个通讯地址类型
typedef string TThostFtdcAddressType
///TFtdcZipCodeType是一个邮政编码类型
typedef string TThostFtdcZipCodeType
///TFtdcTelephoneType是一个联系电话类型
typedef string TThostFtdcTelephoneType
///TFtdcFaxType是一个传真类型
typedef string TThostFtdcFaxType
///TFtdcMobileType是一个手机类型
typedef string TThostFtdcMobileType
///TFtdcEMailType是一个电子邮件类型
typedef string TThostFtdcEMailType
///TFtdcMemoType是一个备注类型
typedef string TThostFtdcMemoType
///TFtdcCompanyCodeType是一个企业代码类型
typedef string TThostFtdcCompanyCodeType
///TFtdcWebsiteType是一个网站地址类型
typedef string TThostFtdcWebsiteType
///TFtdcTaxNoType是一个税务登记号类型
typedef string TThostFtdcTaxNoType
...
typedef string TThostFtdcBatchStatusType
///TFtdcPropertyIDType是一个属性代码类型
typedef string TThostFtdcPropertyIDType
///TFtdcPropertyNameType是一个属性名称类型
typedef string TThostFtdcPropertyNameType
///TFtdcLicenseNoType是一个营业执照号类型
typedef string TThostFtdcLicenseNoType
///TFtdcAgentIDType是一个经纪人代码类型
typedef string TThostFtdcAgentIDType
///TFtdcAgentNameType是一个经纪人名称类型
typedef string TThostFtdcAgentNameType
///TFtdcAgentGroupIDType是一个经纪人组代码类型
typedef string TThostFtdcAgentGroupIDType
///TFtdcAgentGroupNameType是一个经纪人组名称类型
typedef string TThostFtdcAgentGroupNameType
///TFtdcReturnStyleType是一个按品种返还方式类型
///按所有品种
//// THOST_FTDC_RS_All '1'
///按品种
//// THOST_FTDC_RS_ByProduct '2'
typedef string TThostFtdcReturnStyleType
///TFtdcReturnPatternType是一个返还模式类型
///按成交手数
//// THOST_FTDC_RP_ByVolume '1'
///按留存手续费
//// THOST_FTDC_RP_ByFeeOnHand '2'
typedef string TThostFtdcReturnPatternType
...
typedef string TThostFtdcReturnLevelType
///TFtdcReturnStandardType是一个返还标准类型
///分阶段返还
//// THOST_FTDC_RSD_ByPeriod '1'
///按某一标准
//// THOST_FTDC_RSD_ByStandard '2'
typedef string TThostFtdcReturnStandardType
///TFtdcMortgageTypeType是一个质押类型类型
///质出
//// THOST_FTDC_MT_Out '0'
///质入
//// THOST_FTDC_MT_In '1'
typedef string TThostFtdcMortgageTypeType
...
typedef string TThostFtdcInvestorSettlementParamIDType
...
typedef string TThostFtdcExchangeSettlementParamIDType
...
typedef string TThostFtdcSystemParamIDType
...
typedef string TThostFtdcTradeParamIDType
///TFtdcSettlementParamValueType是一个参数代码值类型
typedef string TThostFtdcSettlementParamValueType
///TFtdcCounterIDType是一个计数器代码类型
typedef string TThostFtdcCounterIDType
///TFtdcInvestorGroupNameType是一个投资者分组名称类型
typedef string TThostFtdcInvestorGroupNameType
///TFtdcBrandCodeType是一个牌号类型
typedef string TThostFtdcBrandCodeType
///TFtdcWarehouseType是一个仓库类型
typedef string TThostFtdcWarehouseType
///TFtdcProductDateType是一个产期类型
typedef string TThostFtdcProductDateType
///TFtdcGradeType是一个等级类型
typedef string TThostFtdcGradeType
///TFtdcClassifyType是一个类别类型
typedef string TThostFtdcClassifyType
///TFtdcPositionType是一个货位类型
typedef string TThostFtdcPositionType
///TFtdcYieldlyType是一个产地类型
typedef string TThostFtdcYieldlyType
///TFtdcWeightType是一个公定重量类型
typedef string TThostFtdcWeightType
///TFtdcSubEntryFundNoType是一个分项资金流水号类型
typedef i32 TThostFtdcSubEntryFundNoType
...
typedef string TThostFtdcFileIDType
///TFtdcFileNameType是一个文件名称类型
typedef string TThostFtdcFileNameType
///TFtdcFileTypeType是一个文件上传类型类型
///结算
//// THOST_FTDC_FUT_Settlement '0'
///核对
//// THOST_FTDC_FUT_Check '1'
typedef string TThostFtdcFileTypeType
...
typedef string TThostFtdcFileFormatType
...
typedef string TThostFtdcFileUploadStatusType
///TFtdcTransferDirectionType是一个移仓方向类型
///移出
//// THOST_FTDC_TD_Out '0'
///移入
//// THOST_FTDC_TD_In '1'
typedef string TThostFtdcTransferDirectionType
///TFtdcUploadModeType是一个上传文件类型类型
typedef string TThostFtdcUploadModeType
///TFtdcAccountIDType是一个投资者帐号类型
typedef string TThostFtdcAccountIDType
///TFtdcBankFlagType是一个银行统一标识类型类型
typedef string TThostFtdcBankFlagType
///TFtdcBankAccountType是一个银行账户类型
typedef string TThostFtdcBankAccountType
///TFtdcOpenNameType是一个银行账户的开户人名称类型
typedef string TThostFtdcOpenNameType
///TFtdcOpenBankType是一个银行账户的开户行类型
typedef string TThostFtdcOpenBankType
///TFtdcBankNameType是一个银行名称类型
typedef string TThostFtdcBankNameType
///TFtdcPublishPathType是一个发布路径类型
typedef string TThostFtdcPublishPathType
///TFtdcOperatorIDType是一个操作员代码类型
typedef string TThostFtdcOperatorIDType
///TFtdcMonthCountType是一个月份数量类型
typedef i32 TThostFtdcMonthCountType
///TFtdcAdvanceMonthArrayType是一个月份提前数组类型
typedef string TThostFtdcAdvanceMonthArrayType
///TFtdcDateExprType是一个日期表达式类型
typedef string TThostFtdcDateExprType
///TFtdcInstrumentIDExprType是一个合约代码表达式类型
typedef string TThostFtdcInstrumentIDExprType
///TFtdcInstrumentNameExprType是一个合约名称表达式类型
typedef string TThostFtdcInstrumentNameExprType
///TFtdcSpecialCreateRuleType是一个特殊的创建规则类型
///没有特殊创建规则
//// THOST_FTDC_SC_NoSpecialRule '0'
///不包含春节
//// THOST_FTDC_SC_NoSpringFestival '1'
typedef string TThostFtdcSpecialCreateRuleType
///TFtdcBasisPriceTypeType是一个挂牌基准价类型类型
///上一合约结算价
//// THOST_FTDC_IPT_LastSettlement '1'
///上一合约收盘价
//// THOST_FTDC_IPT_LaseClose '2'
typedef string TThostFtdcBasisPriceTypeType
...
typedef string TThostFtdcProductLifePhaseType
///TFtdcDeliveryModeType是一个交割方式类型
///现金交割
//// THOST_FTDC_DM_CashDeliv '1'
///实物交割
//// THOST_FTDC_DM_CommodityDeliv '2'
typedef string TThostFtdcDeliveryModeType
///TFtdcLogLevelType是一个日志级别类型
typedef string TThostFtdcLogLevelType
///TFtdcProcessNameType是一个存储过程名称类型
typedef string TThostFtdcProcessNameType
///TFtdcOperationMemoType是一个操作摘要类型
typedef string TThostFtdcOperationMemoType
...
typedef string TThostFtdcFundIOTypeType
...
typedef string TThostFtdcFundTypeType
///TFtdcFundDirectionType是一个出入金方向类型
///入金
//// THOST_FTDC_FD_In '1'
///出金
//// THOST_FTDC_FD_Out '2'
typedef string TThostFtdcFundDirectionType
...
typedef string TThostFtdcFundStatusType
///TFtdcBillNoType是一个票据号类型
typedef string TThostFtdcBillNoType
///TFtdcBillNameType是一个票据名称类型
typedef string TThostFtdcBillNameType
...
typedef string TThostFtdcPublishStatusType
///TFtdcEnumValueIDType是一个枚举值代码类型
typedef string TThostFtdcEnumValueIDType
///TFtdcEnumValueTypeType是一个枚举值类型类型
typedef string TThostFtdcEnumValueTypeType
///TFtdcEnumValueLabelType是一个枚举值名称类型
typedef string TThostFtdcEnumValueLabelType
///TFtdcEnumValueResultType是一个枚举值结果类型
typedef string TThostFtdcEnumValueResultType
...
typedef string TThostFtdcSystemStatusType
...
typedef string TThostFtdcSettlementStatusType
///TFtdcRangeIntTypeType是一个限定值类型类型
typedef string TThostFtdcRangeIntTypeType
///TFtdcRangeIntFromType是一个限定值下限类型
typedef string TThostFtdcRangeIntFromType
///TFtdcRangeIntToType是一个限定值上限类型
typedef string TThostFtdcRangeIntToType
///TFtdcFunctionIDType是一个功能代码类型
typedef string TThostFtdcFunctionIDType
///TFtdcFunctionValueCodeType是一个功能编码类型
typedef string TThostFtdcFunctionValueCodeType
///TFtdcFunctionNameType是一个功能名称类型
typedef string TThostFtdcFunctionNameType
///TFtdcRoleIDType是一个角色编号类型
typedef string TThostFtdcRoleIDType
///TFtdcRoleNameType是一个角色名称类型
typedef string TThostFtdcRoleNameType
///TFtdcDescriptionType是一个描述类型
typedef string TThostFtdcDescriptionType
///TFtdcCombineIDType是一个组合编号类型
typedef string TThostFtdcCombineIDType
///TFtdcCombineTypeType是一个组合类型类型
typedef string TThostFtdcCombineTypeType
...
typedef string TThostFtdcInvestorTypeType
///TFtdcBrokerTypeType是一个经纪公司类型类型
///交易会员
//// THOST_FTDC_BT_Trade '0'
///交易结算会员
//// THOST_FTDC_BT_TradeSettle '1'
typedef string TThostFtdcBrokerTypeType
...
typedef string TThostFtdcRiskLevelType
...
typedef string TThostFtdcFeeAcceptStyleType
///TFtdcPasswordTypeType是一个密码类型类型
///交易密码
//// THOST_FTDC_PWDT_Trade '1'
///资金密码
//// THOST_FTDC_PWDT_Account '2'
typedef string TThostFtdcPasswordTypeType
...
typedef string TThostFtdcAllWithoutTradeType
///TFtdcCommentType是一个盈亏算法说明类型
typedef string TThostFtdcCommentType
///TFtdcVersionType是一个版本号类型
typedef string TThostFtdcVersionType
///TFtdcTradeCodeType是一个交易代码类型
typedef string TThostFtdcTradeCodeType
///TFtdcTradeDateType是一个交易日期类型
typedef string TThostFtdcTradeDateType
///TFtdcTradeTimeType是一个交易时间类型
typedef string TThostFtdcTradeTimeType
///TFtdcTradeSerialType是一个发起方流水号类型
typedef string TThostFtdcTradeSerialType
///TFtdcTradeSerialNoType是一个发起方流水号类型
typedef i32 TThostFtdcTradeSerialNoType
///TFtdcFutureIDType是一个期货公司代码类型
typedef string TThostFtdcFutureIDType
///TFtdcBankIDType是一个银行代码类型
typedef string TThostFtdcBankIDType
///TFtdcBankBrchIDType是一个银行分中心代码类型
typedef string TThostFtdcBankBrchIDType
///TFtdcBankBranchIDType是一个分中心代码类型
typedef string TThostFtdcBankBranchIDType
///TFtdcOperNoType是一个交易柜员类型
typedef string TThostFtdcOperNoType
///TFtdcDeviceIDType是一个渠道标志类型
typedef string TThostFtdcDeviceIDType
///TFtdcRecordNumType是一个记录数类型
typedef string TThostFtdcRecordNumType
///TFtdcFutureAccountType是一个期货资金账号类型
typedef string TThostFtdcFutureAccountType
///TFtdcFuturePwdFlagType是一个资金密码核对标志类型
///不核对
//// THOST_FTDC_FPWD_UnCheck '0'
///核对
//// THOST_FTDC_FPWD_Check '1'
typedef string TThostFtdcFuturePwdFlagType
///TFtdcTransferTypeType是一个银期转账类型类型
///银行转期货
//// THOST_FTDC_TT_BankToFuture '0'
///期货转银行
//// THOST_FTDC_TT_FutureToBank '1'
typedef string TThostFtdcTransferTypeType
///TFtdcFutureAccPwdType是一个期货资金密码类型
typedef string TThostFtdcFutureAccPwdType
///TFtdcCurrencyCodeType是一个币种类型
typedef string TThostFtdcCurrencyCodeType
///TFtdcRetCodeType是一个响应代码类型
typedef string TThostFtdcRetCodeType
///TFtdcRetInfoType是一个响应信息类型
typedef string TThostFtdcRetInfoType
///TFtdcTradeAmtType是一个银行总余额类型
typedef string TThostFtdcTradeAmtType
///TFtdcUseAmtType是一个银行可用余额类型
typedef string TThostFtdcUseAmtType
///TFtdcFetchAmtType是一个银行可取余额类型
typedef string TThostFtdcFetchAmtType
...
typedef string TThostFtdcTransferValidFlagType
///TFtdcCertCodeType是一个证件号码类型
typedef string TThostFtdcCertCodeType
...
///其它
//// THOST_FTDC_RN_QT '2'
typedef string TThostFtdcReasonType
///TFtdcFundProjectIDType是一个资金项目编号类型
typedef string TThostFtdcFundProjectIDType
///TFtdcSexType是一个性别类型
///未知
...
typedef string TThostFtdcSexType
///TFtdcProfessionType是一个职业类型
typedef string TThostFtdcProfessionType
///TFtdcNationalType是一个国籍类型
typedef string TThostFtdcNationalType
///TFtdcProvinceType是一个省类型
typedef string TThostFtdcProvinceType
///TFtdcRegionType是一个区类型
typedef string TThostFtdcRegionType
///TFtdcCountryType是一个国家类型
typedef string TThostFtdcCountryType
///TFtdcLicenseNOType是一个营业执照类型
typedef string TThostFtdcLicenseNOType
///TFtdcCompanyTypeType是一个企业性质类型
typedef string TThostFtdcCompanyTypeType
///TFtdcBusinessScopeType是一个经营范围类型
typedef string TThostFtdcBusinessScopeType
///TFtdcCapitalCurrencyType是一个注册资本币种类型
typedef string TThostFtdcCapitalCurrencyType
...
typedef string TThostFtdcUserTypeType
///TFtdcRateTypeType是一个费率类型类型
///保证金率
//// THOST_FTDC_RATETYPE_MarginRate '2'
typedef string TThostFtdcRateTypeType
...
typedef string TThostFtdcNoteTypeType
///TFtdcSettlementStyleType是一个结算单方式类型
///逐日盯市
//// THOST_FTDC_SBS_Day '1'
///逐笔对冲
//// THOST_FTDC_SBS_Volume '2'
typedef string TThostFtdcSettlementStyleType
///TFtdcBrokerDNSType是一个域名类型
typedef string TThostFtdcBrokerDNSType
///TFtdcSentenceType是一个语句类型
typedef string TThostFtdcSentenceType
///TFtdcSettlementBillTypeType是一个结算单类型类型
///日报
//// THOST_FTDC_ST_Day '0'
///月报
//// THOST_FTDC_ST_Month '1'
typedef string TThostFtdcSettlementBillTypeType
...
typedef string TThostFtdcUserRightTypeType
...
typedef string TThostFtdcMarginPriceTypeType
...
typedef string TThostFtdcHandlePositionAlgoIDType
...
typedef string TThostFtdcFindMarginRateAlgoIDType
...
typedef string TThostFtdcHandleTradingAccountAlgoIDType
...
typedef string TThostFtdcPersonTypeType
...
typedef string TThostFtdcQueryInvestorRangeType
...
typedef string TThostFtdcInvestorRiskStatusType
///TFtdcLegIDType是一个单腿编号类型
typedef i32 TThostFtdcLegIDType
///TFtdcLegMultipleType是一个单腿乘数类型
typedef i32 TThostFtdcLegMultipleType
///TFtdcImplyLevelType是一个派生层数类型
typedef i32 TThostFtdcImplyLevelType
///TFtdcClearAccountType是一个结算账户类型
typedef string TThostFtdcClearAccountType
///TFtdcOrganNOType是一个结算账户类型
typedef string TThostFtdcOrganNOType
///TFtdcClearbarchIDType是一个结算账户联行号类型
typedef string TThostFtdcClearbarchIDType
...
typedef string TThostFtdcUserEventTypeType
///TFtdcUserEventInfoType是一个用户事件信息类型
typedef string TThostFtdcUserEventInfoType
///TFtdcCloseStyleType是一个平仓方式类型
///先开先平
//// THOST_FTDC_ICS_Close '0'
///先平今再平昨
//// THOST_FTDC_ICS_CloseToday '1'
typedef string TThostFtdcCloseStyleType
...
typedef string TThostFtdcStatModeType
...
typedef string TThostFtdcParkedOrderStatusType
///TFtdcParkedOrderIDType是一个预埋报单编号类型
typedef string TThostFtdcParkedOrderIDType
///TFtdcParkedOrderActionIDType是一个预埋撤单编号类型
typedef string TThostFtdcParkedOrderActionIDType
///TFtdcVirDealStatusType是一个处理状态类型
///正在处理
//// THOST_FTDC_VDS_Dealing '1'
///处理成功
//// THOST_FTDC_VDS_DeaclSucceed '2'
typedef string TThostFtdcVirDealStatusType
...
typedef string TThostFtdcOrgSystemIDType
...
typedef string TThostFtdcVirTradeStatusType
...
typedef string TThostFtdcVirBankAccTypeType
///TFtdcVirementStatusType是一个银行帐户类型类型
///正常
//// THOST_FTDC_VMS_Natural '0'
///销户
//// THOST_FTDC_VMS_Canceled '9'
typedef string TThostFtdcVirementStatusType
...
typedef string TThostFtdcVirementAvailAbilityType
...
typedef string TThostFtdcVirementTradeCodeType
///TFtdcPhotoTypeNameType是一个影像类型名称类型
typedef string TThostFtdcPhotoTypeNameType
///TFtdcPhotoTypeIDType是一个影像类型代码类型
typedef string TThostFtdcPhotoTypeIDType
///TFtdcPhotoNameType是一个影像名称类型
typedef string TThostFtdcPhotoNameType
///TFtdcTopicIDType是一个主题代码类型
typedef i32 TThostFtdcTopicIDType
///TFtdcReportTypeIDType是一个交易报告类型标识类型
typedef string TThostFtdcReportTypeIDType
///TFtdcCharacterIDType是一个交易特征代码类型
typedef string TThostFtdcCharacterIDType
///TFtdcAMLParamIDType是一个参数代码类型
typedef string TThostFtdcAMLParamIDType
///TFtdcAMLInvestorTypeType是一个投资者类型类型
typedef string TThostFtdcAMLInvestorTypeType
///TFtdcAMLIdCardTypeType是一个证件类型类型
typedef string TThostFtdcAMLIdCardTypeType
///TFtdcAMLTradeDirectType是一个资金进出方向类型
typedef string TThostFtdcAMLTradeDirectType
///TFtdcAMLTradeModelType是一个资金进出方式类型
typedef string TThostFtdcAMLTradeModelType
...
typedef string TThostFtdcAMLCustomerCardTypeType
///TFtdcAMLInstitutionNameType是一个金融机构网点名称类型
typedef string TThostFtdcAMLInstitutionNameType
///TFtdcAMLDistrictIDType是一个金融机构网点所在地区行政区划代码类型
typedef string TThostFtdcAMLDistrictIDType
///TFtdcAMLRelationShipType是一个金融机构网点与大额交易的关系类型
typedef string TThostFtdcAMLRelationShipType
///TFtdcAMLInstitutionTypeType是一个金融机构网点代码类型类型
typedef string TThostFtdcAMLInstitutionTypeType
///TFtdcAMLInstitutionIDType是一个金融机构网点代码类型
typedef string TThostFtdcAMLInstitutionIDType
///TFtdcAMLAccountTypeType是一个账户类型类型
typedef string TThostFtdcAMLAccountTypeType
///TFtdcAMLTradingTypeType是一个交易方式类型
typedef string TThostFtdcAMLTradingTypeType
///TFtdcAMLTransactClassType是一个涉外收支交易分类与代码类型
typedef string TThostFtdcAMLTransactClassType
///TFtdcAMLCapitalIOType是一个资金收付标识类型
typedef string TThostFtdcAMLCapitalIOType
///TFtdcAMLSiteType是一个交易地点类型
typedef string TThostFtdcAMLSiteType
///TFtdcAMLCapitalPurposeType是一个资金用途类型
typedef string TThostFtdcAMLCapitalPurposeType
///TFtdcAMLReportTypeType是一个报文类型类型
typedef string TThostFtdcAMLReportTypeType
///TFtdcAMLSerialNoType是一个编号类型
typedef string TThostFtdcAMLSerialNoType
///TFtdcAMLStatusType是一个状态类型
typedef string TThostFtdcAMLStatusType
///TFtdcAMLGenStatusType是一个Aml生成方式类型
///程序生成
//// THOST_FTDC_GEN_Program '0'
///人工生成
//// THOST_FTDC_GEN_HandWork '1'
typedef string TThostFtdcAMLGenStatusType
///TFtdcAMLSeqCodeType是一个业务标识号类型
typedef string TThostFtdcAMLSeqCodeType
///TFtdcAMLFileNameType是一个AML文件名类型
typedef string TThostFtdcAMLFileNameType
///TFtdcAMLMoneyType是一个反洗钱资金类型
typedef double TThostFtdcAMLMoneyType
///TFtdcAMLFileAmountType是一个反洗钱资金类型
typedef i32 TThostFtdcAMLFileAmountType
///TFtdcCFMMCKeyType是一个密钥类型(保证金监管)类型
typedef string TThostFtdcCFMMCKeyType
///TFtdcCFMMCTokenType是一个令牌类型(保证金监管)类型
typedef string TThostFtdcCFMMCTokenType
...
typedef string TThostFtdcCFMMCKeyKindType
///TFtdcAMLReportNameType是一个报文名称类型
typedef string TThostFtdcAMLReportNameType
///TFtdcIndividualNameType是一个个人姓名类型
typedef string TThostFtdcIndividualNameType
///TFtdcCurrencyIDType是一个币种代码类型
typedef string TThostFtdcCurrencyIDType
///TFtdcCustNumberType是一个客户编号类型
typedef string TThostFtdcCustNumberType
///TFtdcOrganCodeType是一个机构编码类型
typedef string TThostFtdcOrganCodeType
///TFtdcOrganNameType是一个机构名称类型
typedef string TThostFtdcOrganNameType
///TFtdcSuperOrganCodeType是一个上级机构编码,即期货公司总部、银行总行类型
typedef string TThostFtdcSuperOrganCodeType
///TFtdcSubBranchIDType是一个分支机构类型
typedef string TThostFtdcSubBranchIDType
///TFtdcSubBranchNameType是一个分支机构名称类型
typedef string TThostFtdcSubBranchNameType
///TFtdcBranchNetCodeType是一个机构网点号类型
typedef string TThostFtdcBranchNetCodeType
///TFtdcBranchNetNameType是一个机构网点名称类型
typedef string TThostFtdcBranchNetNameType
///TFtdcOrganFlagType是一个机构标识类型
typedef string TThostFtdcOrganFlagType
///TFtdcBankCodingForFutureType是一个银行对期货公司的编码类型
typedef string TThostFtdcBankCodingForFutureType
///TFtdcBankReturnCodeType是一个银行对返回码的定义类型
typedef string TThostFtdcBankReturnCodeType
///TFtdcPlateReturnCodeType是一个银期转帐平台对返回码的定义类型
typedef string TThostFtdcPlateReturnCodeType
///TFtdcBankSubBranchIDType是一个银行分支机构编码类型
typedef string TThostFtdcBankSubBranchIDType
///TFtdcFutureBranchIDType是一个期货分支机构编码类型
typedef string TThostFtdcFutureBranchIDType
///TFtdcReturnCodeType是一个返回代码类型
typedef string TThostFtdcReturnCodeType
///TFtdcOperatorCodeType是一个操作员类型
typedef string TThostFtdcOperatorCodeType
///TFtdcClearDepIDType是一个机构结算帐户机构号类型
typedef string TThostFtdcClearDepIDType
///TFtdcClearBrchIDType是一个机构结算帐户联行号类型
typedef string TThostFtdcClearBrchIDType
///TFtdcClearNameType是一个机构结算帐户名称类型
typedef string TThostFtdcClearNameType
///TFtdcBankAccountNameType是一个银行帐户名称类型
typedef string TThostFtdcBankAccountNameType
///TFtdcInvDepIDType是一个机构投资人账号机构号类型
typedef string TThostFtdcInvDepIDType
///TFtdcInvBrchIDType是一个机构投资人联行号类型
typedef string TThostFtdcInvBrchIDType
///TFtdcMessageFormatVersionType是一个信息格式版本类型
typedef string TThostFtdcMessageFormatVersionType
///TFtdcDigestType是一个摘要类型
typedef string TThostFtdcDigestType
///TFtdcAuthenticDataType是一个认证数据类型
typedef string TThostFtdcAuthenticDataType
///TFtdcPasswordKeyType是一个密钥类型
typedef string TThostFtdcPasswordKeyType
///TFtdcFutureAccountNameType是一个期货帐户名称类型
typedef string TThostFtdcFutureAccountNameType
///TFtdcMobilePhoneType是一个手机类型
typedef string TThostFtdcMobilePhoneType
///TFtdcFutureMainKeyType是一个期货公司主密钥类型
typedef string TThostFtdcFutureMainKeyType
///TFtdcFutureWorkKeyType是一个期货公司工作密钥类型
typedef string TThostFtdcFutureWorkKeyType
///TFtdcFutureTransKeyType是一个期货公司传输密钥类型
typedef string TThostFtdcFutureTransKeyType
///TFtdcBankMainKeyType是一个银行主密钥类型
typedef string TThostFtdcBankMainKeyType
///TFtdcBankWorkKeyType是一个银行工作密钥类型
typedef string TThostFtdcBankWorkKeyType
///TFtdcBankTransKeyType是一个银行传输密钥类型
typedef string TThostFtdcBankTransKeyType
///TFtdcBankServerDescriptionType是一个银行服务器描述信息类型
typedef string TThostFtdcBankServerDescriptionType
///TFtdcAddInfoType是一个附加信息类型
typedef string TThostFtdcAddInfoType
///TFtdcDescrInfoForReturnCodeType是一个返回码描述类型
typedef string TThostFtdcDescrInfoForReturnCodeType
///TFtdcCountryCodeType是一个国家代码类型
typedef string TThostFtdcCountryCodeType
///TFtdcSerialType是一个流水号类型
typedef i32 TThostFtdcSerialType
///TFtdcPlateSerialType是一个平台流水号类型
typedef i32 TThostFtdcPlateSerialType
///TFtdcBankSerialType是一个银行流水号类型
typedef string TThostFtdcBankSerialType
///TFtdcCorrectSerialType是一个被冲正交易流水号类型
typedef i32 TThostFtdcCorrectSerialType
///TFtdcFutureSerialType是一个期货公司流水号类型
typedef i32 TThostFtdcFutureSerialType
///TFtdcApplicationIDType是一个应用标识类型
typedef i32 TThostFtdcApplicationIDType
///TFtdcBankProxyIDType是一个银行代理标识类型
typedef i32 TThostFtdcBankProxyIDType
///TFtdcFBTCoreIDType是一个银期转帐核心系统标识类型
typedef i32 TThostFtdcFBTCoreIDType
///TFtdcServerPortType是一个服务端口号类型
typedef i32 TThostFtdcServerPortType
///TFtdcRepealedTimesType是一个已经冲正次数类型
typedef i32 TThostFtdcRepealedTimesType
///TFtdcRepealTimeIntervalType是一个冲正时间间隔类型
typedef i32 TThostFtdcRepealTimeIntervalType
///TFtdcTotalTimesType是一个每日累计转帐次数类型
typedef i32 TThostFtdcTotalTimesType
///TFtdcFBTRequestIDType是一个请求ID类型
typedef i32 TThostFtdcFBTRequestIDType
///TFtdcTIDType是一个交易ID类型
typedef i32 TThostFtdcTIDType
...
typedef string TThostFtdcCertificationTypeType
...
typedef string TThostFtdcFileBusinessCodeType
///TFtdcCashExchangeCodeType是一个汇钞标志类型
///汇
//// THOST_FTDC_CEC_Exchange '1'
///钞
//// THOST_FTDC_CEC_Cash '2'
typedef string TThostFtdcCashExchangeCodeType
///TFtdcYesNoIndicatorType是一个是或否标识类型
///是
//// THOST_FTDC_YNI_Yes '0'
///否
//// THOST_FTDC_YNI_No '1'
typedef string TThostFtdcYesNoIndicatorType
...
typedef string TThostFtdcBanlanceTypeType
...
typedef string TThostFtdcGenderType
...
typedef string TThostFtdcFeePayFlagType
...
typedef string TThostFtdcPassWordKeyTypeType
...
typedef string TThostFtdcFBTPassWordTypeType
...
typedef string TThostFtdcFBTEncryModeType
...
typedef string TThostFtdcBankRepealFlagType
...
typedef string TThostFtdcBrokerRepealFlagType
...
typedef string TThostFtdcInstitutionTypeType
///TFtdcLastFragmentType是一个最后分片标志类型
///是最后分片
//// THOST_FTDC_LF_Yes '0'
///不是最后分片
//// THOST_FTDC_LF_No '1'
typedef string TThostFtdcLastFragmentType
...
typedef string TThostFtdcBankAccStatusType
///TFtdcMoneyAccountStatusType是一个资金账户状态类型
///正常
//// THOST_FTDC_MAS_Normal '0'
///销户
//// THOST_FTDC_MAS_Cancel '1'
typedef string TThostFtdcMoneyAccountStatusType
...
typedef string TThostFtdcManageStatusType
...
typedef string TThostFtdcSystemTypeType
...
typedef string TThostFtdcTxnEndFlagType
...
typedef string TThostFtdcAvailabilityFlagType
...
typedef string TThostFtdcBankAccTypeType
...
typedef string TThostFtdcFutureAccTypeType
...
typedef string TThostFtdcCommApiTypeType
///TFtdcServiceIDType是一个服务编号类型
typedef i32 TThostFtdcServiceIDType
///TFtdcServiceLineNoType是一个服务线路编号类型
typedef i32 TThostFtdcServiceLineNoType
///TFtdcServiceNameType是一个服务名类型
typedef string TThostFtdcServiceNameType
///TFtdcLinkStatusType是一个连接状态类型
///已经连接
//// THOST_FTDC_LS_Connected '1'
///没有连接
//// THOST_FTDC_LS_Disconnected '2'
typedef string TThostFtdcLinkStatusType
///TFtdcCommApiPointerType是一个通讯API指针类型
typedef i32 TThostFtdcCommApiPointerType
...
typedef string TThostFtdcPwdFlagType
...
typedef string TThostFtdcFBTUserEventTypeType
///TFtdcBankIDByBankType是一个银行自己的编码类型
typedef string TThostFtdcBankIDByBankType
///TFtdcBankOperNoType是一个银行操作员号类型
typedef string TThostFtdcBankOperNoType
///TFtdcBankCustNoType是一个银行客户号类型
typedef string TThostFtdcBankCustNoType
///TFtdcDBOPSeqNoType是一个递增的序列号类型
typedef i32 TThostFtdcDBOPSeqNoType
///TFtdcTableNameType是一个FBT表名类型
typedef string TThostFtdcTableNameType
///TFtdcPKNameType是一个FBT表操作主键名类型
typedef string TThostFtdcPKNameType
///TFtdcPKValueType是一个FBT表操作主键值类型
typedef string TThostFtdcPKValueType
...
typedef string TThostFtdcDBOperationType
///TFtdcSyncFlagType是一个同步标记类型
///已同步
//// THOST_FTDC_SYNF_Yes '0'
///未同步
//// THOST_FTDC_SYNF_No '1'
typedef string TThostFtdcSyncFlagType
///TFtdcTargetIDType是一个同步目标编号类型
typedef string TThostFtdcTargetIDType
...
typedef string TThostFtdcSyncTypeType
///TFtdcFBETimeType是一个各种换汇时间类型
typedef string TThostFtdcFBETimeType
///TFtdcFBEBankNoType是一个换汇银行行号类型
typedef string TThostFtdcFBEBankNoType
///TFtdcFBECertNoType是一个换汇凭证号类型
typedef string TThostFtdcFBECertNoType
///TFtdcExDirectionType是一个换汇方向类型
///结汇
//// THOST_FTDC_FBEDIR_Settlement '0'
///售汇
//// THOST_FTDC_FBEDIR_Sale '1'
typedef string TThostFtdcExDirectionType
///TFtdcFBEBankAccountType是一个换汇银行账户类型
typedef string TThostFtdcFBEBankAccountType
///TFtdcFBEBankAccountNameType是一个换汇银行账户名类型
typedef string TThostFtdcFBEBankAccountNameType
///TFtdcFBEAmtType是一个各种换汇金额类型
typedef double TThostFtdcFBEAmtType
///TFtdcFBEBusinessTypeType是一个换汇业务类型类型
typedef string TThostFtdcFBEBusinessTypeType
///TFtdcFBEPostScriptType是一个换汇附言类型
typedef string TThostFtdcFBEPostScriptType
///TFtdcFBERemarkType是一个换汇备注类型
typedef string TThostFtdcFBERemarkType
...
typedef string TThostFtdcFBEUserEventTypeType
///TFtdcFBEFileNameType是一个换汇相关文件名类型
typedef string TThostFtdcFBEFileNameType
///TFtdcFBEBatchSerialType是一个换汇批次号类型
typedef string TThostFtdcFBEBatchSerialType
...
typedef string TThostFtdcFBEReqFlagType
...
typedef string TThostFtdcNotifyClassType
///TFtdcRiskNofityInfoType是一个客户风险通知消息类型
typedef string TThostFtdcRiskNofityInfoType
///TFtdcForceCloseSceneIdType是一个强平场景编号类型
typedef string TThostFtdcForceCloseSceneIdType
...
typedef string TThostFtdcForceCloseTypeType
///TFtdcInstrumentIDsType是一个多个产品代码,用+分隔,如cu+zn类型
typedef string TThostFtdcInstrumentIDsType
...
typedef string TThostFtdcRiskNotifyMethodType
...
typedef string TThostFtdcRiskNotifyStatusType
///TFtdcRiskUserEventType是一个风控用户操作事件类型
///导出数据
//// THOST_FTDC_RUE_ExportData '0'
typedef string TThostFtdcRiskUserEventType
///TFtdcParamIDType是一个参数代码类型
typedef i32 TThostFtdcParamIDType
///TFtdcParamNameType是一个参数名类型
typedef string TThostFtdcParamNameType
///TFtdcParamValueType是一个参数值类型
typedef string TThostFtdcParamValueType
...
typedef string TThostFtdcConditionalOrderSortTypeType
...
typedef string TThostFtdcSendTypeType
...
typedef string TThostFtdcClientIDStatusType
///TFtdcIndustryIDType是一个行业编码类型
typedef string TThostFtdcIndustryIDType
///TFtdcQuestionIDType是一个特有信息编号类型
typedef string TThostFtdcQuestionIDType
///TFtdcQuestionContentType是一个特有信息说明类型
typedef string TThostFtdcQuestionContentType
///TFtdcOptionIDType是一个选项编号类型
typedef string TThostFtdcOptionIDType
///TFtdcOptionContentType是一个选项说明类型
typedef string TThostFtdcOptionContentType
...
typedef string TThostFtdcQuestionTypeType
///TFtdcProcessIDType是一个业务流水号类型
typedef string TThostFtdcProcessIDType
///TFtdcSeqNoType是一个流水号类型
typedef i32 TThostFtdcSeqNoType
///TFtdcUOAProcessStatusType是一个流程状态类型
typedef string TThostFtdcUOAProcessStatusType
///TFtdcProcessTypeType是一个流程功能类型类型
typedef string TThostFtdcProcessTypeType
...
typedef string TThostFtdcBusinessTypeType
...
typedef string TThostFtdcCfmmcReturnCodeType
///TFtdcExReturnCodeType是一个交易所返回码类型
typedef i32 TThostFtdcExReturnCodeType
...
typedef string TThostFtdcClientTypeType
...
typedef string TThostFtdcExchangeIDTypeType
...
typedef string TThostFtdcExClientIDTypeType
///TFtdcClientClassifyType是一个客户分类码类型
typedef string TThostFtdcClientClassifyType
///TFtdcUOAOrganTypeType是一个单位性质类型
typedef string TThostFtdcUOAOrganTypeType
///TFtdcUOACountryCodeType是一个国家代码类型
typedef string TThostFtdcUOACountryCodeType
///TFtdcAreaCodeType是一个区号类型
typedef string TThostFtdcAreaCodeType
///TFtdcFuturesIDType是一个监控中心为客户分配的代码类型
typedef string TThostFtdcFuturesIDType
///TFtdcCffmcDateType是一个日期类型
typedef string TThostFtdcCffmcDateType
///TFtdcCffmcTimeType是一个时间类型
typedef string TThostFtdcCffmcTimeType
///TFtdcNocIDType是一个组织机构代码类型
typedef string TThostFtdcNocIDType
...
typedef string TThostFtdcUpdateFlagType
...
typedef string TThostFtdcApplyOperateIDType
...
typedef string TThostFtdcApplyStatusIDType
///TFtdcSendMethodType是一个发送方式类型
///文件发送
//// THOST_FTDC_UOASM_ByAPI '1'
///电子发送
//// THOST_FTDC_UOASM_ByFile '2'
typedef string TThostFtdcSendMethodType
///TFtdcEventTypeType是一个业务操作类型类型
typedef string TThostFtdcEventTypeType
...
typedef string TThostFtdcEventModeType
...
typedef string TThostFtdcUOAAutoSendType
///TFtdcQueryDepthType是一个查询深度类型
typedef i32 TThostFtdcQueryDepthType
///TFtdcDataCenterIDType是一个数据中心代码类型
typedef i32 TThostFtdcDataCenterIDType
...
typedef string TThostFtdcFlowIDType
...
///二级复核
//// THOST_FTDC_CL_Two '2'
typedef string TThostFtdcCheckLevelType
///TFtdcCheckNoType是一个操作次数类型
typedef i32 TThostFtdcCheckNoType
...
typedef string TThostFtdcCheckStatusType
...
typedef string TThostFtdcUsedStatusType
///TFtdcRateTemplateNameType是一个模型名称类型
typedef string TThostFtdcRateTemplateNameType
///TFtdcPropertyStringType是一个用于查询的投资属性字段类型
typedef string TThostFtdcPropertyStringType
///TFtdcBankAcountOriginType是一个账户来源类型
///手工录入
//// THOST_FTDC_BAO_ByAccProperty '0'
///银期转账
//// THOST_FTDC_BAO_ByFBTransfer '1'
typedef string TThostFtdcBankAcountOriginType
...
typedef string TThostFtdcMonthBillTradeSumType
...
typedef string TThostFtdcFBTTradeCodeEnumType
///TFtdcRateTemplateIDType是一个模型代码类型
typedef string TThostFtdcRateTemplateIDType
///TFtdcRiskRateType是一个风险度类型
typedef string TThostFtdcRiskRateType
///TFtdcTimestampType是一个时间戳类型
typedef i32 TThostFtdcTimestampType
///TFtdcInvestorIDRuleNameType是一个号段规则名称类型
typedef string TThostFtdcInvestorIDRuleNameType
///TFtdcInvestorIDRuleExprType是一个号段规则表达式类型
typedef string TThostFtdcInvestorIDRuleExprType
///TFtdcLastDriftType是一个上次OTP漂移值类型
typedef i32 TThostFtdcLastDriftType
///TFtdcLastSuccessType是一个上次OTP成功值类型
typedef i32 TThostFtdcLastSuccessType
///TFtdcAuthKeyType是一个令牌密钥类型
typedef string TThostFtdcAuthKeyType
///TFtdcSerialNumberType是一个序列号类型
typedef string TThostFtdcSerialNumberType
///TFtdcOTPTypeType是一个动态令牌类型类型
///无动态令牌
//// THOST_FTDC_OTP_NONE '0'
///时间令牌
//// THOST_FTDC_OTP_TOTP '1'
typedef string TThostFtdcOTPTypeType
///TFtdcOTPVendorsIDType是一个动态令牌提供商类型
typedef string TThostFtdcOTPVendorsIDType
///TFtdcOTPVendorsNameType是一个动态令牌提供商名称类型
typedef string TThostFtdcOTPVendorsNameType
...
typedef string TThostFtdcTradeSumStatModeType
///TFtdcComTypeType是一个组合成交类型类型
typedef i32 TThostFtdcComTypeType
///TFtdcUserProductIDType是一个产品标识类型
typedef string TThostFtdcUserProductIDType
///TFtdcUserProductNameType是一个产品名称类型
typedef string TThostFtdcUserProductNameType
///TFtdcUserProductMemoType是一个产品说明类型
typedef string TThostFtdcUserProductMemoType
///TFtdcCSRCCancelFlagType是一个新增或变更标志类型
typedef string TThostFtdcCSRCCancelFlagType
///TFtdcCSRCDateType是一个日期类型
typedef string TThostFtdcCSRCDateType
///TFtdcCSRCInvestorNameType是一个客户名称类型
typedef string TThostFtdcCSRCInvestorNameType
///TFtdcCSRCOpenInvestorNameType是一个客户名称类型
typedef string TThostFtdcCSRCOpenInvestorNameType
///TFtdcCSRCInvestorIDType是一个客户代码类型
typedef string TThostFtdcCSRCInvestorIDType
///TFtdcCSRCIdentifiedCardNoType是一个证件号码类型
typedef string TThostFtdcCSRCIdentifiedCardNoType
///TFtdcCSRCClientIDType是一个交易编码类型
typedef string TThostFtdcCSRCClientIDType
///TFtdcCSRCBankFlagType是一个银行标识类型
typedef string TThostFtdcCSRCBankFlagType
///TFtdcCSRCBankAccountType是一个银行账户类型
typedef string TThostFtdcCSRCBankAccountType
///TFtdcCSRCOpenNameType是一个开户人类型
typedef string TThostFtdcCSRCOpenNameType
///TFtdcCSRCMemoType是一个说明类型
typedef string TThostFtdcCSRCMemoType
///TFtdcCSRCTimeType是一个时间类型
typedef string TThostFtdcCSRCTimeType
///TFtdcCSRCTradeIDType是一个成交流水号类型
typedef string TThostFtdcCSRCTradeIDType
///TFtdcCSRCExchangeInstIDType是一个合约代码类型
typedef string TThostFtdcCSRCExchangeInstIDType
///TFtdcCSRCMortgageNameType是一个质押品名称类型
typedef string TThostFtdcCSRCMortgageNameType
///TFtdcCSRCReasonType是一个事由类型
typedef string TThostFtdcCSRCReasonType
///TFtdcIsSettlementType是一个是否为非结算会员类型
typedef string TThostFtdcIsSettlementType
...
typedef string TThostFtdcRateInvestorRangeType
///TFtdcAgentBrokerIDType是一个代理经纪公司代码类型
typedef string TThostFtdcAgentBrokerIDType
///TFtdcDRIdentityIDType是一个交易中心代码类型
typedef i32 TThostFtdcDRIdentityIDType
///TFtdcDRIdentityNameType是一个交易中心名称类型
typedef string TThostFtdcDRIdentityNameType
///TFtdcDBLinkIDType是一个DBLink标识号类型
typedef string TThostFtdcDBLinkIDType
...
typedef string TThostFtdcSyncDataStatusType
///TFtdcTradeSourceType是一个成交来源类型
///来自交易所普通回报
//// THOST_FTDC_TSRC_NORMAL '0'
///来自查询
//// THOST_FTDC_TSRC_QUERY '1'
typedef string TThostFtdcTradeSourceType
...
typedef string TThostFtdcFlexStatModeType
///TFtdcByInvestorRangeType是一个投资者范围统计方式类型
///属性统计
//// THOST_FTDC_BIR_Property '1'
///统计所有
//// THOST_FTDC_BIR_All '2'
typedef string TThostFtdcByInvestorRangeType
///TFtdcSRiskRateType是一个风险度类型
typedef string TThostFtdcSRiskRateType
///TFtdcSequenceNo12Type是一个序号类型
typedef i32 TThostFtdcSequenceNo12Type
...
typedef string TThostFtdcPropertyInvestorRangeType
...
typedef string TThostFtdcSysOperModeType
...
typedef string TThostFtdcRightParamTypeType
///TFtdcRightTemplateIDType是一个模板代码类型
typedef string TThostFtdcRightTemplateIDType
///TFtdcRightTemplateNameType是一个模板名称类型
typedef string TThostFtdcRightTemplateNameType
///TFtdcDataStatusType是一个反洗钱审核表数据状态类型
///正常
//// THOST_FTDC_AMLDS_Normal '0'
///已删除
//// THOST_FTDC_AMLDS_Deleted '1'
typedef string TThostFtdcDataStatusType
...
typedef string TThostFtdcAMLCheckStatusType
///TFtdcAmlDateTypeType是一个日期类型类型
///检查日期
//// THOST_FTDC_AMLDT_DrawDay '0'
///发生日期
//// THOST_FTDC_AMLDT_TouchDay '1'
typedef string TThostFtdcAmlDateTypeType
...
typedef string TThostFtdcAmlCheckLevelType
///TFtdcAmlCheckFlowType是一个反洗钱数据抽取审核流程类型
typedef string TThostFtdcAmlCheckFlowType
///TFtdcDataTypeType是一个数据类型类型
typedef string TThostFtdcDataTypeType
...
typedef string TThostFtdcExportFileTypeType
...
typedef string TThostFtdcSettleManagerTypeType
///TFtdcSettleManagerIDType是一个结算配置代码类型
typedef string TThostFtdcSettleManagerIDType
///TFtdcSettleManagerNameType是一个结算配置名称类型
typedef string TThostFtdcSettleManagerNameType
...
typedef string TThostFtdcSettleManagerLevelType
...
typedef string TThostFtdcSettleManagerGroupType
///TFtdcCheckResultMemoType是一个核对结果说明类型
typedef string TThostFtdcCheckResultMemoType
///TFtdcFunctionUrlType是一个功能链接类型
typedef string TThostFtdcFunctionUrlType
///TFtdcAuthInfoType是一个客户端认证信息类型
typedef string TThostFtdcAuthInfoType
///TFtdcAuthCodeType是一个客户端认证码类型
typedef string TThostFtdcAuthCodeType
///TFtdcLimitUseTypeType是一个保值额度使用类型类型
///可重复使用
//// THOST_FTDC_LUT_Repeatable '1'
///不可重复使用
//// THOST_FTDC_LUT_Unrepeatable '2'
typedef string TThostFtdcLimitUseTypeType
...
typedef string TThostFtdcDataResourceType
...
typedef string TThostFtdcMarginTypeType
///TFtdcActiveTypeType是一个生效类型类型
///仅当日生效
//// THOST_FTDC_ACT_Intraday '1'
///长期生效
//// THOST_FTDC_ACT_Long '2'
typedef string TThostFtdcActiveTypeType
...
typedef string TThostFtdcMarginRateTypeType
...
typedef string TThostFtdcBackUpStatusType
...
typedef string TThostFtdcInitSettlementType
...
typedef string TThostFtdcSettArchiveStatusType
...
typedef string TThostFtdcCTPTypeType
///TFtdcToolIDType是一个工具代码类型
typedef string TThostFtdcToolIDType
///TFtdcToolNameType是一个工具名称类型
typedef string TThostFtdcToolNameType
///TFtdcCloseDealTypeType是一个平仓处理类型类型
///正常
//// THOST_FTDC_CDT_Normal '0'
///投机平仓优先
//// THOST_FTDC_CDT_SpecFirst '1'
typedef string TThostFtdcCloseDealTypeType
...
typedef string TThostFtdcMortgageFundUseRangeType
...
typedef string TThostFtdcCurrencySwapStatusType
///TFtdcCurrExchCertNoType是一个凭证号类型
typedef string TThostFtdcCurrExchCertNoType
///TFtdcBatchSerialNoType是一个批次号类型
typedef string TThostFtdcBatchSerialNoType
...
typedef string TThostFtdcReqFlagType
...
typedef string TThostFtdcResFlagType
///TFtdcPageControlType是一个换汇页面控制类型
typedef string TThostFtdcPageControlType
///TFtdcRecordCountType是一个记录数类型
typedef i32 TThostFtdcRecordCountType
///TFtdcCurrencySwapMemoType是一个换汇需确认信息类型
typedef string TThostFtdcCurrencySwapMemoType
///TFtdcExStatusType是一个修改状态类型
///修改前
//// THOST_FTDC_EXS_Before '0'
///修改后
//// THOST_FTDC_EXS_After '1'
typedef string TThostFtdcExStatusType
...
typedef string TThostFtdcClientRegionType
///TFtdcWorkPlaceType是一个工作单位类型
typedef string TThostFtdcWorkPlaceType
///TFtdcBusinessPeriodType是一个经营期限类型
typedef string TThostFtdcBusinessPeriodType
///TFtdcWebSiteType是一个网址类型
typedef string TThostFtdcWebSiteType
///TFtdcUOAIdCardTypeType是一个统一开户证件类型类型
typedef string TThostFtdcUOAIdCardTypeType
///TFtdcClientModeType是一个开户模式类型
typedef string TThostFtdcClientModeType
///TFtdcInvestorFullNameType是一个投资者全称类型
typedef string TThostFtdcInvestorFullNameType
///TFtdcUOABrokerIDType是一个境外中介机构ID类型
typedef string TThostFtdcUOABrokerIDType
///TFtdcUOAZipCodeType是一个邮政编码类型
typedef string TThostFtdcUOAZipCodeType
///TFtdcUOAEMailType是一个电子邮箱类型
typedef string TThostFtdcUOAEMailType
///TFtdcOldCityType是一个城市类型
typedef string TThostFtdcOldCityType
///TFtdcCorporateIdentifiedCardNoType是一个法人代表证件号码类型
typedef string TThostFtdcCorporateIdentifiedCardNoType
///TFtdcHasBoardType是一个是否有董事会类型
///没有
//// THOST_FTDC_HB_No '0'
///有
//// THOST_FTDC_HB_Yes '1'
typedef string TThostFtdcHasBoardType
...
typedef string TThostFtdcStartModeType
...
typedef string TThostFtdcTemplateTypeType
///TFtdcLoginModeType是一个登录模式类型
///交易
//// THOST_FTDC_LM_Trade '0'
///转账
//// THOST_FTDC_LM_Transfer '1'
typedef string TThostFtdcLoginModeType
///TFtdcPromptTypeType是一个日历提示类型类型
///合约上下市
//// THOST_FTDC_CPT_Instrument '1'
///保证金分段生效
//// THOST_FTDC_CPT_Margin '2'
typedef string TThostFtdcPromptTypeType
///TFtdcLedgerManageIDType是一个分户管理资产编码类型
typedef string TThostFtdcLedgerManageIDType
///TFtdcInvestVarietyType是一个投资品种类型
typedef string TThostFtdcInvestVarietyType
///TFtdcBankAccountTypeType是一个账户类别类型
typedef string TThostFtdcBankAccountTypeType
///TFtdcLedgerManageBankType是一个开户银行类型
typedef string TThostFtdcLedgerManageBankType
///TFtdcCffexDepartmentNameType是一个开户营业部类型
typedef string TThostFtdcCffexDepartmentNameType
///TFtdcCffexDepartmentCodeType是一个营业部代码类型
typedef string TThostFtdcCffexDepartmentCodeType
///TFtdcHasTrusteeType是一个是否有托管人类型
///有
//// THOST_FTDC_HT_Yes '1'
///没有
//// THOST_FTDC_HT_No '0'
typedef string TThostFtdcHasTrusteeType
///TFtdcCSRCMemo1Type是一个说明类型
typedef string TThostFtdcCSRCMemo1Type
///TFtdcAssetmgrCFullNameType是一个代理资产管理业务的期货公司全称类型
typedef string TThostFtdcAssetmgrCFullNameType
///TFtdcAssetmgrApprovalNOType是一个资产管理业务批文号类型
typedef string TThostFtdcAssetmgrApprovalNOType
///TFtdcAssetmgrMgrNameType是一个资产管理业务负责人姓名类型
typedef string TThostFtdcAssetmgrMgrNameType
...
typedef string TThostFtdcAmTypeType
///TFtdcCSRCAmTypeType是一个机构类型类型
typedef string TThostFtdcCSRCAmTypeType
///TFtdcCSRCFundIOTypeType是一个出入金类型类型
///出入金
//// THOST_FTDC_CFIOT_FundIO '0'
///银期换汇
//// THOST_FTDC_CFIOT_SwapCurrency '1'
typedef string TThostFtdcCSRCFundIOTypeType
...
typedef string TThostFtdcCusAccountTypeType
///TFtdcCSRCNationalType是一个国籍类型
typedef string TThostFtdcCSRCNationalType
///TFtdcCSRCSecAgentIDType是一个二级代理ID类型
typedef string TThostFtdcCSRCSecAgentIDType
///TFtdcLanguageTypeType是一个通知语言类型类型
///中文
//// THOST_FTDC_LT_Chinese '1'
///英文
//// THOST_FTDC_LT_English '2'
typedef string TThostFtdcLanguageTypeType
///TFtdcAmAccountType是一个投资账户类型
typedef string TThostFtdcAmAccountType
...
typedef string TThostFtdcAssetmgrClientTypeType
///TFtdcAssetmgrTypeType是一个投资类型类型
///期货类
//// THOST_FTDC_ASST_Futures '3'
///综合类
//// THOST_FTDC_ASST_SpecialOrgan '4'
typedef string TThostFtdcAssetmgrTypeType
///TFtdcUOMType是一个计量单位类型
typedef string TThostFtdcUOMType
///TFtdcSHFEInstLifePhaseType是一个上期所合约生命周期状态类型
typedef string TThostFtdcSHFEInstLifePhaseType
///TFtdcSHFEProductClassType是一个产品类型类型
typedef string TThostFtdcSHFEProductClassType
///TFtdcPriceDecimalType是一个价格小数位类型
typedef string TThostFtdcPriceDecimalType
///TFtdcInTheMoneyFlagType是一个平值期权标志类型
typedef string TThostFtdcInTheMoneyFlagType
...
typedef string TThostFtdcCheckInstrTypeType
///TFtdcDeliveryTypeType是一个交割类型类型
///手工交割
//// THOST_FTDC_DT_HandDeliv '1'
///到期交割
//// THOST_FTDC_DT_PersonDeliv '2'
typedef string TThostFtdcDeliveryTypeType
...
typedef string TThostFtdcMaxMarginSideAlgorithmType
...
typedef string TThostFtdcDAClientTypeType
///TFtdcCombinInstrIDType是一个套利合约代码类型
typedef string TThostFtdcCombinInstrIDType
///TFtdcCombinSettlePriceType是一个各腿结算价类型
typedef string TThostFtdcCombinSettlePriceType
///TFtdcDCEPriorityType是一个优先级类型
typedef i32 TThostFtdcDCEPriorityType
///TFtdcTradeGroupIDType是一个成交组号类型
typedef i32 TThostFtdcTradeGroupIDType
///TFtdcIsCheckPrepaType是一个是否校验开户可用资金类型
typedef i32 TThostFtdcIsCheckPrepaType
///TFtdcUOAAssetmgrTypeType是一个投资类型类型
///期货类
//// THOST_FTDC_UOAAT_Futures '1'
///综合类
//// THOST_FTDC_UOAAT_SpecialOrgan '2'
typedef string TThostFtdcUOAAssetmgrTypeType
///TFtdcDirectionEnType是一个买卖方向类型
///Buy
//// THOST_FTDC_DEN_Buy '0'
///Sell
//// THOST_FTDC_DEN_Sell '1'
typedef string TThostFtdcDirectionEnType
...
typedef string TThostFtdcOffsetFlagEnType
...
typedef string TThostFtdcHedgeFlagEnType
...
typedef string TThostFtdcFundIOTypeEnType
...
typedef string TThostFtdcExecResultType
///TFtdcStrikeSequenceType是一个执行序号类型
typedef i32 TThostFtdcStrikeSequenceType
///TFtdcStrikeTimeType是一个执行时间类型
typedef string TThostFtdcStrikeTimeType
...
typedef string TThostFtdcForQuoteStatusType
/////////////////////////////////////////////////////////////////////////
...
typedef string TThostFtdcCZCEUploadFileNameType
...
typedef string TThostFtdcDCEUploadFileNameType
...
typedef string TThostFtdcSHFEUploadFileNameType
...
typedef string TThostFtdcCFFEXUploadFileNameType